...
public class StringJsonUserTypeTest extends Doofenshmirtz<Client> {

  StringJsonUserType target;

  @Override
  @Before
  public void setup() throws Exception {
    super.setup();
    target = new StringJsonUserType();
  }

  @Test
  public void type() throws Exception {
    assertThat(StringJsonUserType.class, notNullValue());
  }
  ...
  public void nullSafeSet_A$PreparedStatement$Object$int$SharedSessionContractImplementor_T$SQLException()
    ...
    doThrow(SQLException.class).when(st).setNull(any(Integer.class), any(Integer.class));
    when(rs.getString(any(String.class))).thenThrow(SQLException.class);
    target.nullSafeSet(st, value, index, session);
  }
