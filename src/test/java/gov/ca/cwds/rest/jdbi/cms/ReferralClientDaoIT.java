...
public class ReferralClientDaoIT {
	...
	public void testCreate() {
		ReferralClient referralClient = new ReferralClient("86XV1bG06k", "AazXkWY06k", "", (short) 122, (short) 681,
				"S", null, "N", "N", "", (short) 2, "", "", "Y", "N", "N");
	...
	public void testCreateExistingEntityException() {
		...
		ReferralClient referralClient = new ReferralClient("LNuzMKw06s", "AazXkWY06s", "", (short) 122, (short) 681,
				"S", null, "N", "N", "", (short) 2, "", "", "Y", "N", "N");
	...
	public void testUpdateEntityNotFoundException() {
		...
		ReferralClient referralClient = new ReferralClient("ZZuzMKw06s", "AazXkWY06s", "", (short) 122, (short) 681,
				"S", null, "N", "N", "", (short) 2, "", "", "Y", "N", "N");
