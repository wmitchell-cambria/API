...
public class EducationProviderContactDaoIT {
  ...
  public void testFindAllNamedQueryExist() throws Exception {
    Query query = session
        .getNamedQuery("gov.ca.cwds.rest.api.persistence.cms.EducationProviderContact.findAll");
  ...
  public void testFindAllUpdatedAfterNameQueryExist() throws Exception {
    Query query = session.getNamedQuery(
        "gov.ca.cwds.rest.api.persistence.cms.EducationProviderContact.findAllUpdatedAfter");
    assertThat(query, is(notNullValue()));
  }
