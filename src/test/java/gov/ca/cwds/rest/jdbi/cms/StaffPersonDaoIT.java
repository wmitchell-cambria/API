...
public class StaffPersonDaoIT {
	...
	public void testCreate() {
		StaffPerson staffPerson = new StaffPerson("q1k", null, "External Interface", "external interface", "SCXCIN7",
				" ", "", BigDecimal.valueOf(9165672100L), 0, null, "    ", "N", "MIZN02k00E", "  ", "    ", "99", "N",
				"3XPCP92q38", null);
	...
	public void testCreateExistingEntityException() {
		...
		StaffPerson staffPerson = new StaffPerson("q1p", null, "External Interface", "external interface", "SCXCIN7",
				" ", "", BigDecimal.valueOf(9165672100L), 0, null, "    ", "N", "MIZN02k00E", "  ", "    ", "99", "N",
				"3XPCP92q38", null);
	...
	public void testUpdateEntityNotFoundException() {
		...
		StaffPerson staffPerson = new StaffPerson("q1q", null, "External Interface", "external interface", "SCXCIN7",
				" ", "", BigDecimal.valueOf(9165672100L), 0, null, "    ", "N", "MIZN02k00E", "  ", "    ", "99", "N",
				"3XPCP92q38", null);
