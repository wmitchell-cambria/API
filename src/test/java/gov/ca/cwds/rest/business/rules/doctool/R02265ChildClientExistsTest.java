...
public class R02265ChildClientExistsTest {
  ...
  private gov.ca.cwds.data.persistence.cms.Client client;
  private gov.ca.cwds.data.persistence.cms.Client client1;
    ...
    when(clientDao.create(any(gov.ca.cwds.data.persistence.cms.Client.class)))
        .thenAnswer(new Answer<gov.ca.cwds.data.persistence.cms.Client>() {
          ...
          public gov.ca.cwds.data.persistence.cms.Client answer(InvocationOnMock invocation)
              throws Throwable {
            client = (gov.ca.cwds.data.persistence.cms.Client) invocation.getArguments()[0];
            if (client.getChildClientIndicatorVar() == "Y") {
              client1 = client;
            }
            return client;
          }
   ...
   */
  @Test
  public void testForChildClientIndicator() throws Exception {
    ...
    gov.ca.cwds.data.persistence.cms.Allegation allegationToCreate =
        new gov.ca.cwds.data.persistence.cms.Allegation("2345678ABC",
            (Allegation) allegationDomain.toArray()[0], "0X5", new Date());
    ...
    assertThat(client1.getChildClientIndicatorVar(), is(equalTo("Y")));
  }
