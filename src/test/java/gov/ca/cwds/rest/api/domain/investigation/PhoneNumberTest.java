...
public class PhoneNumberTest {
  ...
  private LegacyDescriptor legacyDescriptor =
      new LegacyDescriptor("1234567ABC", "111-222-333-4444333", dateTime, "CLIENT_T", "Client");
  ...
  public void testDomainConstructorSuccess() {
    PhoneNumber phoneNumber = new PhoneNumber(phone, phoneExtension, phoneType, legacyDescriptor);
    ...
    assertThat(phoneNumber.getLegacyDescriptor(), is(equalTo(legacyDescriptor)));
  }

  @Test
  public void shouldCompareEqualsToObjectWithSameValues() {
    PhoneNumber phoneNumber = new PhoneNumber(phone, phoneExtension, phoneType, legacyDescriptor);
    PhoneNumber phoneNumber1 = new PhoneNumber(phone, phoneExtension, phoneType, legacyDescriptor);
  ...
  public void shouldCompareNotEqualsToObjectWithDifferentValues() {
    PhoneNumber phoneNumber = new PhoneNumber(phone, phoneExtension, phoneType, legacyDescriptor);
    PhoneNumber phoneNumber1 = new PhoneNumber(phone1, phoneExtension, phoneType, legacyDescriptor);
