...
public class CrossReportTest {
  ...
  public void persistentObjectConstructorTest() throws Exception {
    ...
    assertThat(totest.getGovernmentOrgCrossRptIndicatorVar(), is(equalTo(
        DomainObject.uncookBooleanString(persistent.getGovernmentOrgCrossRptIndicatorVar()))));
    ...
    assertThat(totest.getOutStateLawEnforcementIndicator(), is(equalTo(
        DomainObject.uncookBooleanString(persistent.getOutStateLawEnforcementIndicator()))));
  ...
  private CrossReport validCrossReport() {
    return new CrossReport("ABC1234567", (short) 123, false, false, "16:41:49", "AB123", 234,
        new BigDecimal(1234567), "2016-01-31", "ABC23", "DE123", "1234567ABC", "1234567ABC", "q1p",
