...
public class ReferralClientTest {
	...
	private static final ReferralClientResourceImpl mockedReferralClientResource = mock(
			ReferralClientResourceImpl.class);
	...
	public void deserializesFromJSON() throws Exception {
		assertThat(MAPPER.readValue(fixture("fixtures/legacy/ReferralClient/valid/valid.json"), ReferralClient.class),
				is(equalTo(validReferralClient())));
	}
	...
	public void persistentObjectConstructorTest() throws Exception {
		ReferralClient domain = new ReferralClient(approvalNumber, approvalStatusType,
				dispositionClosureReasonType, dispositionCode, dispositionDate, selfReportedIndicator,
				staffPersonAddedIndicator, referralId, clientId, dispositionClosureDescription, ageNumber,
				agePeriodCode, countySpecificCode, mentalHealthIssuesIndicator, alcoholIndicator, drugIndicator);
		gov.ca.cwds.rest.api.persistence.legacy.ReferralClient persistent = new gov.ca.cwds.rest.api.persistence.legacy.ReferralClient(domain, "lastUpdatedId");
		...
		assertThat(totest.getDispositionClosureReasonType(), is(equalTo(persistent.getDispositionClosureReasonType())));
	...
	public void jsonCreatorConstructorTest() throws Exception {
		ReferralClient referralClient = new ReferralClient(approvalNumber, approvalStatusType,
				dispositionClosureReasonType, dispositionCode, dispositionDate, selfReportedIndicator,
				staffPersonAddedIndicator, referralId, clientId, dispositionClosureDescription, ageNumber,
				agePeriodCode, countySpecificCode, mentalHealthIssuesIndicator, alcoholIndicator, drugIndicator);
		...
		assertThat(referralClient.getDispositionClosureReasonType(), is(equalTo(dispositionClosureReasonType)));
		...
		assertThat(referralClient.getDispositionClosureDescription(), is(equalTo(dispositionClosureDescription)));
	...
	public void successfulWithValid() throws Exception {
		ReferralClient toCreate = MAPPER.readValue(fixture("fixtures/legacy/ReferralClient/valid/valid.json"),
	...
	public void successfulWithOptionalsNotIncluded() throws Exception {
		ReferralClient toCreate = MAPPER.readValue(
				fixture("fixtures/legacy/ReferralClient/valid/optionalsNotIncluded.json"), ReferralClient.class);
		assertThat(resources.client().target(ROOT_RESOURCE).request().accept(Api.Version.JSON_VERSION_1.getMediaType())
				.post(Entity.entity(toCreate, Api.MEDIA_TYPE_JSON_V1)).getStatus(), is(equalTo(204)));
	}
	...
	public void successWhenApprovalNumberEmpty() throws Exception {
		ReferralClient toCreate = MAPPER.readValue(
				fixture("fixtures/legacy/ReferralClient/invalid/approvalNumber/empty.json"), ReferralClient.class);
	...
	public void successWhenApprovalNumberNull() throws Exception {
		ReferralClient toCreate = MAPPER.readValue(
				fixture("fixtures/legacy/ReferralClient/invalid/approvalNumber/null.json"), ReferralClient.class);
		Response response = resources.client().target(ROOT_RESOURCE).request()
				.accept(Api.Version.JSON_VERSION_1.getMediaType())
				.post(Entity.entity(toCreate, Api.MEDIA_TYPE_JSON_V1));
		assertThat(response.getStatus(), is(equalTo(204)));
	...
	public void failsWhenApprovalNumberTooLong() throws Exception {
		ReferralClient toCreate = MAPPER.readValue(
				fixture("fixtures/legacy/ReferralClient/invalid/approvalNumber/tooLong.json"), ReferralClient.class);
		Response response = resources.client().target(ROOT_RESOURCE).request()
				.accept(Api.Version.JSON_VERSION_1.getMediaType())
				.post(Entity.entity(toCreate, Api.MEDIA_TYPE_JSON_V1));
	...
	public void failsWhenDispositionClosureReasonTypeMissing() throws Exception {
		...
		Response response = resources.client().target(ROOT_RESOURCE).request()
				...
				.post(Entity.entity(toCreate, Api.MEDIA_TYPE_JSON_V1));
		assertThat(response.getStatus(), is(equalTo(422)));
		assertThat(response.readEntity(String.class).indexOf("dispositionClosureReasonType may not be null"),
				is(greaterThanOrEqualTo(0)));
	}
	...
	public void failsWhenApprovalStatusTypeNull() throws Exception {
		ReferralClient toCreate = MAPPER.readValue(
				fixture("fixtures/legacy/ReferralClient/invalid/approvalStatusType/null.json"), ReferralClient.class);
		Response response = resources.client().target(ROOT_RESOURCE).request()
				.accept(Api.Version.JSON_VERSION_1.getMediaType())
				.post(Entity.entity(toCreate, Api.MEDIA_TYPE_JSON_V1));
		assertThat(response.getStatus(), is(equalTo(422)));
	...
	public void failsWhenDispositionCodeMissing() throws Exception {
		ReferralClient toCreate = MAPPER.readValue(
				fixture("fixtures/legacy/ReferralClient/invalid/dispositionCode/missing.json"), ReferralClient.class);
		Response response = resources.client().target(ROOT_RESOURCE).request()
				.accept(Api.Version.JSON_VERSION_1.getMediaType())
				.post(Entity.entity(toCreate, Api.MEDIA_TYPE_JSON_V1));
		assertThat(response.getStatus(), is(equalTo(422)));
	...
	public void failsWhenDispositionCodeNull() throws Exception {
		ReferralClient toCreate = MAPPER.readValue(
				fixture("fixtures/legacy/ReferralClient/invalid/dispositionCode/null.json"), ReferralClient.class);
		Response response = resources.client().target(ROOT_RESOURCE).request()
				.accept(Api.Version.JSON_VERSION_1.getMediaType())
				.post(Entity.entity(toCreate, Api.MEDIA_TYPE_JSON_V1));
		assertThat(response.getStatus(), is(equalTo(422)));
	...
	public void failsWhenDispositionCodeEmpty() throws Exception {
		ReferralClient toCreate = MAPPER.readValue(
				fixture("fixtures/legacy/ReferralClient/invalid/dispositionCode/empty.json"), ReferralClient.class);
		Response response = resources.client().target(ROOT_RESOURCE).request()
				.accept(Api.Version.JSON_VERSION_1.getMediaType())
				.post(Entity.entity(toCreate, Api.MEDIA_TYPE_JSON_V1));
		assertThat(response.getStatus(), is(equalTo(422)));
	...
	public void failsWhenDispositionCodeTooLong() throws Exception {
		ReferralClient toCreate = MAPPER.readValue(
				fixture("fixtures/legacy/ReferralClient/invalid/dispositionCode/tooLong.json"), ReferralClient.class);
		Response response = resources.client().target(ROOT_RESOURCE).request()
				.accept(Api.Version.JSON_VERSION_1.getMediaType())
				.post(Entity.entity(toCreate, Api.MEDIA_TYPE_JSON_V1));
		assertThat(response.getStatus(), is(equalTo(422)));
	...
	public void successWhenDispositionDateEmpty() throws Exception {
		ReferralClient toCreate = MAPPER.readValue(
				fixture("fixtures/legacy/ReferralClient/invalid/dispositionDate/empty.json"), ReferralClient.class);
		Response response = resources.client().target(ROOT_RESOURCE).request()
				.accept(Api.Version.JSON_VERSION_1.getMediaType())
				.post(Entity.entity(toCreate, Api.MEDIA_TYPE_JSON_V1));
		assertThat(response.getStatus(), is(equalTo(204)));
	...
	public void successWhenDispositionDateNull() throws Exception {
		ReferralClient toCreate = MAPPER.readValue(
				fixture("fixtures/legacy/ReferralClient/invalid/dispositionDate/null.json"), ReferralClient.class);
		Response response = resources.client().target(ROOT_RESOURCE).request()
				.accept(Api.Version.JSON_VERSION_1.getMediaType())
				.post(Entity.entity(toCreate, Api.MEDIA_TYPE_JSON_V1));
		assertThat(response.getStatus(), is(equalTo(204)));
	...
	public void failsWhenReferralIdMissing() throws Exception {
		ReferralClient toCreate = MAPPER.readValue(
				fixture("fixtures/legacy/ReferralClient/invalid/referralId/missing.json"), ReferralClient.class);
		Response response = resources.client().target(ROOT_RESOURCE).request()
				.accept(Api.Version.JSON_VERSION_1.getMediaType())
				.post(Entity.entity(toCreate, Api.MEDIA_TYPE_JSON_V1));
		assertThat(response.getStatus(), is(equalTo(422)));
	...
	public void failsWhenReferralIdNull() throws Exception {
		ReferralClient toCreate = MAPPER.readValue(
				fixture("fixtures/legacy/ReferralClient/invalid/referralId/null.json"), ReferralClient.class);
		Response response = resources.client().target(ROOT_RESOURCE).request()
				.accept(Api.Version.JSON_VERSION_1.getMediaType())
				.post(Entity.entity(toCreate, Api.MEDIA_TYPE_JSON_V1));
		assertThat(response.getStatus(), is(equalTo(422)));
	...
	public void failsWhenReferralIdEmpty() throws Exception {
		ReferralClient toCreate = MAPPER.readValue(
				fixture("fixtures/legacy/ReferralClient/invalid/referralId/empty.json"), ReferralClient.class);
		Response response = resources.client().target(ROOT_RESOURCE).request()
				.accept(Api.Version.JSON_VERSION_1.getMediaType())
				.post(Entity.entity(toCreate, Api.MEDIA_TYPE_JSON_V1));
		assertThat(response.getStatus(), is(equalTo(422)));
	...
	public void failsWhenReferralIdTooLong() throws Exception {
		ReferralClient toCreate = MAPPER.readValue(
				fixture("fixtures/legacy/ReferralClient/invalid/referralId/tooLong.json"), ReferralClient.class);
		Response response = resources.client().target(ROOT_RESOURCE).request()
				.accept(Api.Version.JSON_VERSION_1.getMediaType())
				.post(Entity.entity(toCreate, Api.MEDIA_TYPE_JSON_V1));
		assertThat(response.getStatus(), is(equalTo(422)));
	...
	public void failsWhenClientIdMissing() throws Exception {
		ReferralClient toCreate = MAPPER.readValue(
				fixture("fixtures/legacy/ReferralClient/invalid/clientId/missing.json"), ReferralClient.class);
		Response response = resources.client().target(ROOT_RESOURCE).request()
				.accept(Api.Version.JSON_VERSION_1.getMediaType())
				.post(Entity.entity(toCreate, Api.MEDIA_TYPE_JSON_V1));
		assertThat(response.getStatus(), is(equalTo(422)));
	...
	public void failsWhenClientIdNull() throws Exception {
		ReferralClient toCreate = MAPPER.readValue(fixture("fixtures/legacy/ReferralClient/invalid/clientId/null.json"),
				ReferralClient.class);
		Response response = resources.client().target(ROOT_RESOURCE).request()
				.accept(Api.Version.JSON_VERSION_1.getMediaType())
				.post(Entity.entity(toCreate, Api.MEDIA_TYPE_JSON_V1));
	...
	public void failsWhenClientIdEmpty() throws Exception {
		ReferralClient toCreate = MAPPER
				.readValue(fixture("fixtures/legacy/ReferralClient/invalid/clientId/empty.json"), ReferralClient.class);
		Response response = resources.client().target(ROOT_RESOURCE).request()
				.accept(Api.Version.JSON_VERSION_1.getMediaType())
				.post(Entity.entity(toCreate, Api.MEDIA_TYPE_JSON_V1));
		assertThat(response.getStatus(), is(equalTo(422)));
	...
	public void failsWhenClientIdTooLong() throws Exception {
		ReferralClient toCreate = MAPPER.readValue(
				fixture("fixtures/legacy/ReferralClient/invalid/clientId/tooLong.json"), ReferralClient.class);
		Response response = resources.client().target(ROOT_RESOURCE).request()
				.accept(Api.Version.JSON_VERSION_1.getMediaType())
				.post(Entity.entity(toCreate, Api.MEDIA_TYPE_JSON_V1));
		assertThat(response.getStatus(), is(equalTo(422)));
	...
	public void failsWhenDispositionClosureDescriptionMissing() throws Exception {
		...
		Response response = resources.client().target(ROOT_RESOURCE).request()
				...
				.post(Entity.entity(toCreate, Api.MEDIA_TYPE_JSON_V1));
		assertThat(response.getStatus(), is(equalTo(422)));
		assertThat(response.readEntity(String.class).indexOf("dispositionClosureDescription may not be empty"),
				is(greaterThanOrEqualTo(0)));
	}
	...
	public void failsWhenAgeNumberMissing() throws Exception {
		ReferralClient toCreate = MAPPER.readValue(
				fixture("fixtures/legacy/ReferralClient/invalid/ageNumber/missing.json"), ReferralClient.class);
		Response response = resources.client().target(ROOT_RESOURCE).request()
				.accept(Api.Version.JSON_VERSION_1.getMediaType())
				.post(Entity.entity(toCreate, Api.MEDIA_TYPE_JSON_V1));
		assertThat(response.getStatus(), is(equalTo(422)));
	...
	public void failsWhenAgeNumberNull() throws Exception {
		ReferralClient toCreate = MAPPER
				.readValue(fixture("fixtures/legacy/ReferralClient/invalid/ageNumber/null.json"), ReferralClient.class);
		Response response = resources.client().target(ROOT_RESOURCE).request()
				.accept(Api.Version.JSON_VERSION_1.getMediaType())
				.post(Entity.entity(toCreate, Api.MEDIA_TYPE_JSON_V1));
		assertThat(response.getStatus(), is(equalTo(422)));
	...
	public void failsWhenAgePeriodCodeMissing() throws Exception {
		ReferralClient toCreate = MAPPER.readValue(
				fixture("fixtures/legacy/ReferralClient/invalid/agePeriodCode/missing.json"), ReferralClient.class);
		Response response = resources.client().target(ROOT_RESOURCE).request()
				.accept(Api.Version.JSON_VERSION_1.getMediaType())
				.post(Entity.entity(toCreate, Api.MEDIA_TYPE_JSON_V1));
		assertThat(response.getStatus(), is(equalTo(422)));
	...
	public void failsWhenAgePeriodCodeNull() throws Exception {
		ReferralClient toCreate = MAPPER.readValue(
				fixture("fixtures/legacy/ReferralClient/invalid/agePeriodCode/null.json"), ReferralClient.class);
		Response response = resources.client().target(ROOT_RESOURCE).request()
				.accept(Api.Version.JSON_VERSION_1.getMediaType())
				.post(Entity.entity(toCreate, Api.MEDIA_TYPE_JSON_V1));
		assertThat(response.getStatus(), is(equalTo(422)));
	...
	public void failsWhenAgePeriodCodeEmpty() throws Exception {
		ReferralClient toCreate = MAPPER.readValue(
				fixture("fixtures/legacy/ReferralClient/invalid/agePeriodCode/empty.json"), ReferralClient.class);
		Response response = resources.client().target(ROOT_RESOURCE).request()
				.accept(Api.Version.JSON_VERSION_1.getMediaType())
				.post(Entity.entity(toCreate, Api.MEDIA_TYPE_JSON_V1));
		assertThat(response.getStatus(), is(equalTo(422)));
	...
	public void failsWhenAgePeriodCodeTooLong() throws Exception {
		ReferralClient toCreate = MAPPER.readValue(
				fixture("fixtures/legacy/ReferralClient/invalid/agePeriodCode/tooLong.json"), ReferralClient.class);
		Response response = resources.client().target(ROOT_RESOURCE).request()
				.accept(Api.Version.JSON_VERSION_1.getMediaType())
				.post(Entity.entity(toCreate, Api.MEDIA_TYPE_JSON_V1));
		assertThat(response.getStatus(), is(equalTo(422)));
	...
	public void failsWhenCountySpecificCodeNull() throws Exception {
		ReferralClient toCreate = MAPPER.readValue(
				fixture("fixtures/legacy/ReferralClient/invalid/countySpecificCode/null.json"), ReferralClient.class);
		Response response = resources.client().target(ROOT_RESOURCE).request()
				.accept(Api.Version.JSON_VERSION_1.getMediaType())
				.post(Entity.entity(toCreate, Api.MEDIA_TYPE_JSON_V1));
		assertThat(response.getStatus(), is(equalTo(422)));
	...
	public void failsWhenCountySpecificCodeEmpty() throws Exception {
		ReferralClient toCreate = MAPPER.readValue(
				fixture("fixtures/legacy/ReferralClient/invalid/countySpecificCode/empty.json"), ReferralClient.class);
		Response response = resources.client().target(ROOT_RESOURCE).request()
				.accept(Api.Version.JSON_VERSION_1.getMediaType())
				.post(Entity.entity(toCreate, Api.MEDIA_TYPE_JSON_V1));
		assertThat(response.getStatus(), is(equalTo(422)));
	...
	public void successWhenAlcoholIndicatorEmpty() throws Exception {
		ReferralClient toCreate = MAPPER.readValue(
				fixture("fixtures/legacy/ReferralClient/invalid/alcoholIndicator/empty.json"), ReferralClient.class);
		Response response = resources.client().target(ROOT_RESOURCE).request()
				.accept(Api.Version.JSON_VERSION_1.getMediaType())
				.post(Entity.entity(toCreate, Api.MEDIA_TYPE_JSON_V1));
		assertThat(response.getStatus(), is(equalTo(204)));
	...
	public void successWhenAlcoholIndicatorNull() throws Exception {
		ReferralClient toCreate = MAPPER.readValue(
				fixture("fixtures/legacy/ReferralClient/invalid/alcoholIndicator/null.json"), ReferralClient.class);
		Response response = resources.client().target(ROOT_RESOURCE).request()
				.accept(Api.Version.JSON_VERSION_1.getMediaType())
				.post(Entity.entity(toCreate, Api.MEDIA_TYPE_JSON_V1));
		assertThat(response.getStatus(), is(equalTo(204)));
	...
	public void successWhenDrugIndicatorEmpty() throws Exception {
		ReferralClient toCreate = MAPPER.readValue(
				fixture("fixtures/legacy/ReferralClient/invalid/drugIndicator/empty.json"), ReferralClient.class);
		Response response = resources.client().target(ROOT_RESOURCE).request()
				.accept(Api.Version.JSON_VERSION_1.getMediaType())
				.post(Entity.entity(toCreate, Api.MEDIA_TYPE_JSON_V1));
		assertThat(response.getStatus(), is(equalTo(204)));
	...
	public void successWhenDrugIndicatorNull() throws Exception {
		ReferralClient toCreate = MAPPER.readValue(
				fixture("fixtures/legacy/ReferralClient/invalid/drugIndicator/null.json"), ReferralClient.class);
		Response response = resources.client().target(ROOT_RESOURCE).request()
				.accept(Api.Version.JSON_VERSION_1.getMediaType())
				.post(Entity.entity(toCreate, Api.MEDIA_TYPE_JSON_V1));
		assertThat(response.getStatus(), is(equalTo(204)));
	...
	private ReferralClient validReferralClient() {
		return new ReferralClient("A123", new Short((short) 123), new Short((short) 123), "A", "2000-01-01", false,
				false, "abc", "abc", "description abc", new Short((short) 12), "M", "AB", false, false, false);
	}
}
