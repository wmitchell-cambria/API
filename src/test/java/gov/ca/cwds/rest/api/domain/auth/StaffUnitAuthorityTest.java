...
public class StaffUnitAuthorityTest {
  ...
  private String description = "Supervisor";
  ...
  public void jsonCreatorConstructorTest() throws Exception {
    ...
    StaffUnitAuthority domain =
        new StaffUnitAuthority("Unitwide Read", "ABC123", "Sacramento", "Supervisor");
  ...
  private StaffUnitAuthority validStaffUnitAuthority() {
    return new StaffUnitAuthority("Unitwide Read", "ABC123", "Sacramento", "Supervisor");
  }
}
