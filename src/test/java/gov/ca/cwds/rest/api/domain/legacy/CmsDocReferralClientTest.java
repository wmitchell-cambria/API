...
public class CmsDocReferralClientTest {
  ...
  public void setup() {
    ...
    DataAccessEnvironment.register(gov.ca.cwds.rest.api.persistence.cms.CmsDocReferralClient.class,
        crudsDao);
  ...
  public void persistentObjectConstructorTest() throws Exception {
    ...
    gov.ca.cwds.rest.api.persistence.cms.CmsDocReferralClient persistent =
        new gov.ca.cwds.rest.api.persistence.cms.CmsDocReferralClient(domain.getId(),
            rc1.getReferlId(), rc1.getClientId(), rc1.getCommonFirstName(),
            rc1.getCommonMiddleName(), rc1.getCommonLastName(),
            DomainObject.uncookDateString(rc1.getBirthDate()), rc1.getOtherName(),
            rc1.getNameType(), rc1.getAddress(), rc1.getAddressType());
