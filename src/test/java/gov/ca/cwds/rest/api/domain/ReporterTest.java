...
public class ReporterTest {
	...
	@ClassRule
	public static final ResourceTestRule resources = ResourceTestRule.builder().addResource(mockedReporterResource)
			.build();
	...
	public void persistentObjectConstructorTest() throws Exception {
		Reporter domain = new Reporter(badgeNumber, cityName, colltrClientRptrReltnshpType, communicationMethodType,
				confidentialWaiverIndicator, drmsMandatedRprtrFeedback, employerName, feedbackDate,
				feedbackRequiredIndicator, firstName, lastName, mandatedReporterIndicator, messagePhoneExtensionNumber,
				messagePhoneNumber, middleInitialName, namePrefixDescription, primaryPhoneNumber,
				primaryPhoneExtensionNumber, stateCodeType, streetName, streetNumber, suffixTitleDescription, zipNumber,
				referralId, lawEnforcementId, zipSuffixNumber, countySpecificCode);
		gov.ca.cwds.rest.api.persistence.legacy.Reporter persistent = new gov.ca.cwds.rest.api.persistence.legacy.Reporter(
				domain, "lastUpdatedId");
		...
		assertThat(totest.getColltrClientRptrReltnshpType(), is(equalTo(persistent.getColltrClientRptrReltnshpType())));
		...
		assertThat(totest.getDrmsMandatedRprtrFeedback(), is(equalTo(persistent.getDrmsMandatedRprtrFeedback())));
		...
		assertThat(totest.getMessagePhoneExtensionNumber(), is(equalTo(persistent.getMessagePhoneExtensionNumber())));
		...
		assertThat(totest.getSuffixTitleDescription(), is(equalTo(persistent.getSuffixTitleDescription())));
	...
	public void jsonCreatorConstructorTest() throws Exception {
		Reporter reporter = new Reporter(badgeNumber, cityName, colltrClientRptrReltnshpType, communicationMethodType,
				confidentialWaiverIndicator, drmsMandatedRprtrFeedback, employerName, feedbackDate,
				feedbackRequiredIndicator, firstName, lastName, mandatedReporterIndicator, messagePhoneExtensionNumber,
				messagePhoneNumber, middleInitialName, namePrefixDescription, primaryPhoneNumber,
				primaryPhoneExtensionNumber, stateCodeType, streetName, streetNumber, suffixTitleDescription, zipNumber,
		...
		assertThat(reporter.getColltrClientRptrReltnshpType(), is(equalTo(colltrClientRptrReltnshpType)));
	...
	public void deserializesFromJSON() throws Exception {
		assertThat(MAPPER.readValue(fixture("fixtures/legacy/Reporter/valid/valid.json"), Reporter.class),
	...
	public void successfulWithOptionalsNotIncluded() throws Exception {
		Reporter toCreate = MAPPER.readValue(fixture("fixtures/legacy/Reporter/valid/optionalsNotIncluded.json"),
				Reporter.class);
		assertThat(resources.client().target(ROOT_RESOURCE).request().accept(Api.Version.JSON_VERSION_1.getMediaType())
				.post(Entity.entity(toCreate, Api.MEDIA_TYPE_JSON_V1)).getStatus(), is(equalTo(204)));
	}
	...
	public void failsWhenBadgeNumberMissing() throws Exception {
		Reporter toCreate = MAPPER.readValue(fixture("fixtures/legacy/Reporter/invalid/badgeNumber/missing.json"),
				Reporter.class);
	...
	public void failsWhenBadgeNumberNull() throws Exception {
		Reporter toCreate = MAPPER.readValue(fixture("fixtures/legacy/Reporter/invalid/badgeNumber/null.json"),
				Reporter.class);
		Response response = resources.client().target(ROOT_RESOURCE).request()
				.accept(Api.Version.JSON_VERSION_1.getMediaType())
				.post(Entity.entity(toCreate, Api.MEDIA_TYPE_JSON_V1));
	...
	public void failsWhenBadgeNumberEmpty() throws Exception {
		Reporter toCreate = MAPPER.readValue(fixture("fixtures/legacy/Reporter/invalid/badgeNumber/empty.json"),
				Reporter.class);
		Response response = resources.client().target(ROOT_RESOURCE).request()
				.accept(Api.Version.JSON_VERSION_1.getMediaType())
				.post(Entity.entity(toCreate, Api.MEDIA_TYPE_JSON_V1));
	...
	public void failsWhenBadgeNumberTooLong() throws Exception {
		Reporter toCreate = MAPPER.readValue(fixture("fixtures/legacy/Reporter/invalid/badgeNumber/tooLong.json"),
				Reporter.class);
		Response response = resources.client().target(ROOT_RESOURCE).request()
				.accept(Api.Version.JSON_VERSION_1.getMediaType())
				.post(Entity.entity(toCreate, Api.MEDIA_TYPE_JSON_V1));
		assertThat(response.getStatus(), is(equalTo(422)));
		assertThat(response.readEntity(String.class).indexOf("badgeNumber size must be between 1 and 6"),
				is(greaterThanOrEqualTo(0)));
	}
	...
	public void failsWhenCityNameMissing() throws Exception {
		Reporter toCreate = MAPPER.readValue(fixture("fixtures/legacy/Reporter/invalid/cityName/missing.json"),
				Reporter.class);
		Response response = resources.client().target(ROOT_RESOURCE).request()
				.accept(Api.Version.JSON_VERSION_1.getMediaType())
				.post(Entity.entity(toCreate, Api.MEDIA_TYPE_JSON_V1));
	...
	public void failsWhenCityNameNull() throws Exception {
		Reporter toCreate = MAPPER.readValue(fixture("fixtures/legacy/Reporter/invalid/cityName/null.json"),
				Reporter.class);
		Response response = resources.client().target(ROOT_RESOURCE).request()
				.accept(Api.Version.JSON_VERSION_1.getMediaType())
				.post(Entity.entity(toCreate, Api.MEDIA_TYPE_JSON_V1));
	...
	public void failsWhenCityNameEmpty() throws Exception {
		Reporter toCreate = MAPPER.readValue(fixture("fixtures/legacy/Reporter/invalid/cityName/empty.json"),
				Reporter.class);
		Response response = resources.client().target(ROOT_RESOURCE).request()
				.accept(Api.Version.JSON_VERSION_1.getMediaType())
				.post(Entity.entity(toCreate, Api.MEDIA_TYPE_JSON_V1));
	...
	public void failsWhenCityNameTooLong() throws Exception {
		Reporter toCreate = MAPPER.readValue(fixture("fixtures/legacy/Reporter/invalid/cityName/tooLong.json"),
				Reporter.class);
		Response response = resources.client().target(ROOT_RESOURCE).request()
				.accept(Api.Version.JSON_VERSION_1.getMediaType())
				.post(Entity.entity(toCreate, Api.MEDIA_TYPE_JSON_V1));
	...
	public void failsWhenColltrClientRptrReltnshpTypeMissing() throws Exception {
		Reporter toCreate = MAPPER.readValue(
				fixture("fixtures/legacy/Reporter/invalid/colltrClientRptrReltnshpType/missing.json"), Reporter.class);
		Response response = resources.client().target(ROOT_RESOURCE).request()
				.accept(Api.Version.JSON_VERSION_1.getMediaType())
				.post(Entity.entity(toCreate, Api.MEDIA_TYPE_JSON_V1));
		assertThat(response.getStatus(), is(equalTo(422)));
		assertThat(response.readEntity(String.class).indexOf("colltrClientRptrReltnshpType may not be null"),
				is(greaterThanOrEqualTo(0)));
	}
	...
	public void failsWhenColltrClientRptrReltnshpTypeNull() throws Exception {
		Reporter toCreate = MAPPER.readValue(
				fixture("fixtures/legacy/Reporter/invalid/colltrClientRptrReltnshpType/null.json"), Reporter.class);
		Response response = resources.client().target(ROOT_RESOURCE).request()
				.accept(Api.Version.JSON_VERSION_1.getMediaType())
				.post(Entity.entity(toCreate, Api.MEDIA_TYPE_JSON_V1));
		assertThat(response.getStatus(), is(equalTo(422)));
	...
	public void failsWhenCommunicationMethodTypeMissing() throws Exception {
		Reporter toCreate = MAPPER.readValue(
				fixture("fixtures/legacy/Reporter/invalid/communicationMethodType/missing.json"), Reporter.class);
		Response response = resources.client().target(ROOT_RESOURCE).request()
				.accept(Api.Version.JSON_VERSION_1.getMediaType())
				.post(Entity.entity(toCreate, Api.MEDIA_TYPE_JSON_V1));
		assertThat(response.getStatus(), is(equalTo(422)));
	...
	public void failsWhenCommunicationMethodTypeNull() throws Exception {
		Reporter toCreate = MAPPER.readValue(
				fixture("fixtures/legacy/Reporter/invalid/communicationMethodType/null.json"), Reporter.class);
		Response response = resources.client().target(ROOT_RESOURCE).request()
				.accept(Api.Version.JSON_VERSION_1.getMediaType())
				.post(Entity.entity(toCreate, Api.MEDIA_TYPE_JSON_V1));
		assertThat(response.getStatus(), is(equalTo(422)));
	...
	public void failsWhenConfidentialWaiverIndicatorMissing() throws Exception {
		Reporter toCreate = MAPPER.readValue(
				fixture("fixtures/legacy/Reporter/invalid/confidentialWaiverIndicator/missing.json"), Reporter.class);
		Response response = resources.client().target(ROOT_RESOURCE).request()
				.accept(Api.Version.JSON_VERSION_1.getMediaType())
				.post(Entity.entity(toCreate, Api.MEDIA_TYPE_JSON_V1));
		assertThat(response.getStatus(), is(equalTo(422)));
		assertThat(response.readEntity(String.class).indexOf("confidentialWaiverIndicator may not be null"),
				is(greaterThanOrEqualTo(0)));
	}
	...
	public void failsWhenConfidentialWaiverIndicatorNull() throws Exception {
		Reporter toCreate = MAPPER.readValue(
				fixture("fixtures/legacy/Reporter/invalid/confidentialWaiverIndicator/null.json"), Reporter.class);
		Response response = resources.client().target(ROOT_RESOURCE).request()
				.accept(Api.Version.JSON_VERSION_1.getMediaType())
				.post(Entity.entity(toCreate, Api.MEDIA_TYPE_JSON_V1));
		assertThat(response.getStatus(), is(equalTo(422)));
	...
	public void failsWhenConfidentialWaiverIndicatorEmpty() throws Exception {
		Reporter toCreate = MAPPER.readValue(
				fixture("fixtures/legacy/Reporter/invalid/confidentialWaiverIndicator/empty.json"), Reporter.class);
		Response response = resources.client().target(ROOT_RESOURCE).request()
				.accept(Api.Version.JSON_VERSION_1.getMediaType())
				.post(Entity.entity(toCreate, Api.MEDIA_TYPE_JSON_V1));
		assertThat(response.getStatus(), is(equalTo(422)));
	...
	public void successWhenDrmsMandatedRprtrFeedbackEmpty() throws Exception {
		Reporter toCreate = MAPPER.readValue(
				fixture("fixtures/legacy/Reporter/invalid/drmsMandatedRprtrFeedback/empty.json"), Reporter.class);
		Response response = resources.client().target(ROOT_RESOURCE).request()
				.accept(Api.Version.JSON_VERSION_1.getMediaType())
				.post(Entity.entity(toCreate, Api.MEDIA_TYPE_JSON_V1));
	...
	public void successWhenDrmsMandatedRprtrFeedbackNull() throws Exception {
		Reporter toCreate = MAPPER.readValue(
				fixture("fixtures/legacy/Reporter/invalid/drmsMandatedRprtrFeedback/null.json"), Reporter.class);
		Response response = resources.client().target(ROOT_RESOURCE).request()
				.accept(Api.Version.JSON_VERSION_1.getMediaType())
				.post(Entity.entity(toCreate, Api.MEDIA_TYPE_JSON_V1));
		assertThat(response.getStatus(), is(equalTo(204)));
	...
	public void failsWhenDrmsMandatedRprtrFeedbackTooLong() throws Exception {
		Reporter toCreate = MAPPER.readValue(
				fixture("fixtures/legacy/Reporter/invalid/drmsMandatedRprtrFeedback/tooLong.json"), Reporter.class);
		Response response = resources.client().target(ROOT_RESOURCE).request()
				.accept(Api.Version.JSON_VERSION_1.getMediaType())
				.post(Entity.entity(toCreate, Api.MEDIA_TYPE_JSON_V1));
		assertThat(response.getStatus(), is(equalTo(422)));
		assertThat(response.readEntity(String.class).indexOf("drmsMandatedRprtrFeedback size must be between 0 and 10"),
				is(greaterThanOrEqualTo(0)));
	}
	...
	public void failsWhenEmployerNameMissing() throws Exception {
		Reporter toCreate = MAPPER.readValue(fixture("fixtures/legacy/Reporter/invalid/employerName/missing.json"),
				Reporter.class);
		Response response = resources.client().target(ROOT_RESOURCE).request()
				.accept(Api.Version.JSON_VERSION_1.getMediaType())
				.post(Entity.entity(toCreate, Api.MEDIA_TYPE_JSON_V1));
	...
	public void failsWhenEmployerNameNull() throws Exception {
		Reporter toCreate = MAPPER.readValue(fixture("fixtures/legacy/Reporter/invalid/employerName/null.json"),
				Reporter.class);
		Response response = resources.client().target(ROOT_RESOURCE).request()
				.accept(Api.Version.JSON_VERSION_1.getMediaType())
				.post(Entity.entity(toCreate, Api.MEDIA_TYPE_JSON_V1));
	...
	public void failsWhenEmployerNameEmpty() throws Exception {
		Reporter toCreate = MAPPER.readValue(fixture("fixtures/legacy/Reporter/invalid/employerName/empty.json"),
				Reporter.class);
		Response response = resources.client().target(ROOT_RESOURCE).request()
				.accept(Api.Version.JSON_VERSION_1.getMediaType())
				.post(Entity.entity(toCreate, Api.MEDIA_TYPE_JSON_V1));
	...
	public void failsWhenEmployerNameTooLong() throws Exception {
		Reporter toCreate = MAPPER.readValue(fixture("fixtures/legacy/Reporter/invalid/employerName/tooLong.json"),
				Reporter.class);
		Response response = resources.client().target(ROOT_RESOURCE).request()
				.accept(Api.Version.JSON_VERSION_1.getMediaType())
				.post(Entity.entity(toCreate, Api.MEDIA_TYPE_JSON_V1));
		assertThat(response.getStatus(), is(equalTo(422)));
		assertThat(response.readEntity(String.class).indexOf("employerName size must be between 1 and 35"),
				is(greaterThanOrEqualTo(0)));
	}
	...
	public void successWhenFeedbackDateEmpty() throws Exception {
		Reporter toCreate = MAPPER.readValue(fixture("fixtures/legacy/Reporter/invalid/feedbackDate/empty.json"),
				Reporter.class);
		Response response = resources.client().target(ROOT_RESOURCE).request()
				.accept(Api.Version.JSON_VERSION_1.getMediaType())
				.post(Entity.entity(toCreate, Api.MEDIA_TYPE_JSON_V1));
	...
	public void successWhenFeedbackDateNull() throws Exception {
		Reporter toCreate = MAPPER.readValue(fixture("fixtures/legacy/Reporter/invalid/feedbackDate/null.json"),
				Reporter.class);
		Response response = resources.client().target(ROOT_RESOURCE).request()
				.accept(Api.Version.JSON_VERSION_1.getMediaType())
				.post(Entity.entity(toCreate, Api.MEDIA_TYPE_JSON_V1));
	...
	public void failsWhenFeedbackDateWrongFormat() throws Exception {
		Reporter toCreate = MAPPER.readValue(fixture("fixtures/legacy/Reporter/invalid/feedbackDate/wrongFormat.json"),
				Reporter.class);
		Response response = resources.client().target(ROOT_RESOURCE).request()
				.accept(Api.Version.JSON_VERSION_1.getMediaType())
				.post(Entity.entity(toCreate, Api.MEDIA_TYPE_JSON_V1));
		assertThat(response.getStatus(), is(equalTo(422)));
		assertThat(response.readEntity(String.class).indexOf("feedbackDate must be in the format of yyyy-MM-dd"),
				is(greaterThanOrEqualTo(0)));
	}
	...
	public void failsWhenFeedbackRequiredIndicatorMissing() throws Exception {
		Reporter toCreate = MAPPER.readValue(
				fixture("fixtures/legacy/Reporter/invalid/feedbackRequiredIndicator/missing.json"), Reporter.class);
		Response response = resources.client().target(ROOT_RESOURCE).request()
				.accept(Api.Version.JSON_VERSION_1.getMediaType())
				.post(Entity.entity(toCreate, Api.MEDIA_TYPE_JSON_V1));
		assertThat(response.getStatus(), is(equalTo(422)));
		assertThat(response.readEntity(String.class).indexOf("feedbackRequiredIndicator may not be null"),
				is(greaterThanOrEqualTo(0)));
	}
	...
	public void failsWhenFeedbackRequiredIndicatorNull() throws Exception {
		Reporter toCreate = MAPPER.readValue(
				fixture("fixtures/legacy/Reporter/invalid/feedbackRequiredIndicator/null.json"), Reporter.class);
		Response response = resources.client().target(ROOT_RESOURCE).request()
				.accept(Api.Version.JSON_VERSION_1.getMediaType())
				.post(Entity.entity(toCreate, Api.MEDIA_TYPE_JSON_V1));
		assertThat(response.getStatus(), is(equalTo(422)));
	...
	public void failsWhenFeedbackRequiredIndicatorEmpty() throws Exception {
		Reporter toCreate = MAPPER.readValue(
				fixture("fixtures/legacy/Reporter/invalid/feedbackRequiredIndicator/empty.json"), Reporter.class);
		Response response = resources.client().target(ROOT_RESOURCE).request()
				.accept(Api.Version.JSON_VERSION_1.getMediaType())
				.post(Entity.entity(toCreate, Api.MEDIA_TYPE_JSON_V1));
		assertThat(response.getStatus(), is(equalTo(422)));
	...
	public void failsWhenFirstNameMissing() throws Exception {
		Reporter toCreate = MAPPER.readValue(fixture("fixtures/legacy/Reporter/invalid/firstName/missing.json"),
				Reporter.class);
		Response response = resources.client().target(ROOT_RESOURCE).request()
				.accept(Api.Version.JSON_VERSION_1.getMediaType())
				.post(Entity.entity(toCreate, Api.MEDIA_TYPE_JSON_V1));
	...
	public void failsWhenFirstNameNull() throws Exception {
		Reporter toCreate = MAPPER.readValue(fixture("fixtures/legacy/Reporter/invalid/firstName/null.json"),
				Reporter.class);
		Response response = resources.client().target(ROOT_RESOURCE).request()
				.accept(Api.Version.JSON_VERSION_1.getMediaType())
				.post(Entity.entity(toCreate, Api.MEDIA_TYPE_JSON_V1));
	...
	public void failsWhenFirstNameEmpty() throws Exception {
		Reporter toCreate = MAPPER.readValue(fixture("fixtures/legacy/Reporter/invalid/firstName/empty.json"),
				Reporter.class);
		Response response = resources.client().target(ROOT_RESOURCE).request()
				.accept(Api.Version.JSON_VERSION_1.getMediaType())
				.post(Entity.entity(toCreate, Api.MEDIA_TYPE_JSON_V1));
	...
	public void failsWhenFirstNameTooLong() throws Exception {
		Reporter toCreate = MAPPER.readValue(fixture("fixtures/legacy/Reporter/invalid/firstName/tooLong.json"),
				Reporter.class);
		Response response = resources.client().target(ROOT_RESOURCE).request()
				.accept(Api.Version.JSON_VERSION_1.getMediaType())
				.post(Entity.entity(toCreate, Api.MEDIA_TYPE_JSON_V1));
	...
	public void failsWhenLastNameMissing() throws Exception {
		Reporter toCreate = MAPPER.readValue(fixture("fixtures/legacy/Reporter/invalid/lastName/missing.json"),
				Reporter.class);
		Response response = resources.client().target(ROOT_RESOURCE).request()
				.accept(Api.Version.JSON_VERSION_1.getMediaType())
				.post(Entity.entity(toCreate, Api.MEDIA_TYPE_JSON_V1));
	...
	public void failsWhenLastNameNull() throws Exception {
		Reporter toCreate = MAPPER.readValue(fixture("fixtures/legacy/Reporter/invalid/lastName/null.json"),
				Reporter.class);
		Response response = resources.client().target(ROOT_RESOURCE).request()
				.accept(Api.Version.JSON_VERSION_1.getMediaType())
				.post(Entity.entity(toCreate, Api.MEDIA_TYPE_JSON_V1));
	...
	public void failsWhenLastNameEmpty() throws Exception {
		Reporter toCreate = MAPPER.readValue(fixture("fixtures/legacy/Reporter/invalid/lastName/empty.json"),
				Reporter.class);
		Response response = resources.client().target(ROOT_RESOURCE).request()
				.accept(Api.Version.JSON_VERSION_1.getMediaType())
				.post(Entity.entity(toCreate, Api.MEDIA_TYPE_JSON_V1));
	...
	public void failsWhenLastNameTooLong() throws Exception {
		Reporter toCreate = MAPPER.readValue(fixture("fixtures/legacy/Reporter/invalid/lastName/tooLong.json"),
				Reporter.class);
		Response response = resources.client().target(ROOT_RESOURCE).request()
				.accept(Api.Version.JSON_VERSION_1.getMediaType())
				.post(Entity.entity(toCreate, Api.MEDIA_TYPE_JSON_V1));
	...
	public void failsWhenMandatedReporterIndicatorMissing() throws Exception {
		Reporter toCreate = MAPPER.readValue(
				fixture("fixtures/legacy/Reporter/invalid/mandatedReporterIndicator/missing.json"), Reporter.class);
		Response response = resources.client().target(ROOT_RESOURCE).request()
				.accept(Api.Version.JSON_VERSION_1.getMediaType())
				.post(Entity.entity(toCreate, Api.MEDIA_TYPE_JSON_V1));
		assertThat(response.getStatus(), is(equalTo(422)));
		assertThat(response.readEntity(String.class).indexOf("mandatedReporterIndicator may not be null"),
				is(greaterThanOrEqualTo(0)));
	}
	...
	public void failsWhenMandatedReporterIndicatorNull() throws Exception {
		Reporter toCreate = MAPPER.readValue(
				fixture("fixtures/legacy/Reporter/invalid/mandatedReporterIndicator/null.json"), Reporter.class);
		Response response = resources.client().target(ROOT_RESOURCE).request()
				.accept(Api.Version.JSON_VERSION_1.getMediaType())
				.post(Entity.entity(toCreate, Api.MEDIA_TYPE_JSON_V1));
		assertThat(response.getStatus(), is(equalTo(422)));
	...
	public void failsWhenMandatedReporterIndicatorEmpty() throws Exception {
		Reporter toCreate = MAPPER.readValue(
				fixture("fixtures/legacy/Reporter/invalid/mandatedReporterIndicator/empty.json"), Reporter.class);
		Response response = resources.client().target(ROOT_RESOURCE).request()
				.accept(Api.Version.JSON_VERSION_1.getMediaType())
				.post(Entity.entity(toCreate, Api.MEDIA_TYPE_JSON_V1));
		assertThat(response.getStatus(), is(equalTo(422)));
	...
	*/
	...
	public void failsWhenMessagePhoneNumberMissing() throws Exception {
		Reporter toCreate = MAPPER
				.readValue(fixture("fixtures/legacy/Reporter/invalid/messagePhoneNumber/missing.json"), Reporter.class);
		Response response = resources.client().target(ROOT_RESOURCE).request()
				.accept(Api.Version.JSON_VERSION_1.getMediaType())
				.post(Entity.entity(toCreate, Api.MEDIA_TYPE_JSON_V1));
		assertThat(response.getStatus(), is(equalTo(422)));
	...
	public void failsWhenMessagePhoneNumberNull() throws Exception {
		Reporter toCreate = MAPPER.readValue(fixture("fixtures/legacy/Reporter/invalid/messagePhoneNumber/null.json"),
				Reporter.class);
		Response response = resources.client().target(ROOT_RESOURCE).request()
				.accept(Api.Version.JSON_VERSION_1.getMediaType())
				.post(Entity.entity(toCreate, Api.MEDIA_TYPE_JSON_V1));
	...
	public void failsWhenMiddleInitialNameMissing() throws Exception {
		Reporter toCreate = MAPPER.readValue(fixture("fixtures/legacy/Reporter/invalid/middleInitialName/missing.json"),
				Reporter.class);
		Response response = resources.client().target(ROOT_RESOURCE).request()
				.accept(Api.Version.JSON_VERSION_1.getMediaType())
				.post(Entity.entity(toCreate, Api.MEDIA_TYPE_JSON_V1));
	...
	public void failsWhenMiddleInitialNameNull() throws Exception {
		Reporter toCreate = MAPPER.readValue(fixture("fixtures/legacy/Reporter/invalid/middleInitialName/null.json"),
				Reporter.class);
		Response response = resources.client().target(ROOT_RESOURCE).request()
				.accept(Api.Version.JSON_VERSION_1.getMediaType())
				.post(Entity.entity(toCreate, Api.MEDIA_TYPE_JSON_V1));
	...
	public void failsWhenMiddleInitialNameEmpty() throws Exception {
		Reporter toCreate = MAPPER.readValue(fixture("fixtures/legacy/Reporter/invalid/middleInitialName/empty.json"),
				Reporter.class);
		Response response = resources.client().target(ROOT_RESOURCE).request()
				.accept(Api.Version.JSON_VERSION_1.getMediaType())
				.post(Entity.entity(toCreate, Api.MEDIA_TYPE_JSON_V1));
	...
	public void failsWhenMiddleInitialNameTooLong() throws Exception {
		Reporter toCreate = MAPPER.readValue(fixture("fixtures/legacy/Reporter/invalid/middleInitialName/tooLong.json"),
				Reporter.class);
		Response response = resources.client().target(ROOT_RESOURCE).request()
				.accept(Api.Version.JSON_VERSION_1.getMediaType())
				.post(Entity.entity(toCreate, Api.MEDIA_TYPE_JSON_V1));
	...
	public void failsWhenNamePrefixDescriptionMissing() throws Exception {
		Reporter toCreate = MAPPER.readValue(
				fixture("fixtures/legacy/Reporter/invalid/namePrefixDescription/missing.json"), Reporter.class);
		Response response = resources.client().target(ROOT_RESOURCE).request()
				.accept(Api.Version.JSON_VERSION_1.getMediaType())
				.post(Entity.entity(toCreate, Api.MEDIA_TYPE_JSON_V1));
		assertThat(response.getStatus(), is(equalTo(422)));
	...
	public void failsWhenNamePrefixDescriptionNull() throws Exception {
		Reporter toCreate = MAPPER
				.readValue(fixture("fixtures/legacy/Reporter/invalid/namePrefixDescription/null.json"), Reporter.class);
		Response response = resources.client().target(ROOT_RESOURCE).request()
				.accept(Api.Version.JSON_VERSION_1.getMediaType())
				.post(Entity.entity(toCreate, Api.MEDIA_TYPE_JSON_V1));
		assertThat(response.getStatus(), is(equalTo(422)));
	...
	public void failsWhenNamePrefixDescriptionEmpty() throws Exception {
		Reporter toCreate = MAPPER.readValue(
				fixture("fixtures/legacy/Reporter/invalid/namePrefixDescription/empty.json"), Reporter.class);
		Response response = resources.client().target(ROOT_RESOURCE).request()
				.accept(Api.Version.JSON_VERSION_1.getMediaType())
				.post(Entity.entity(toCreate, Api.MEDIA_TYPE_JSON_V1));
		assertThat(response.getStatus(), is(equalTo(422)));
	...
	public void failsWhenNamePrefixDescriptionTooLong() throws Exception {
		Reporter toCreate = MAPPER.readValue(
				fixture("fixtures/legacy/Reporter/invalid/namePrefixDescription/tooLong.json"), Reporter.class);
		Response response = resources.client().target(ROOT_RESOURCE).request()
				.accept(Api.Version.JSON_VERSION_1.getMediaType())
				.post(Entity.entity(toCreate, Api.MEDIA_TYPE_JSON_V1));
		assertThat(response.getStatus(), is(equalTo(422)));
		assertThat(response.readEntity(String.class).indexOf("namePrefixDescription size must be between 1 and 6"),
				is(greaterThanOrEqualTo(0)));
	}
	...
	public void failsWhenPrimaryPhoneNumberMissing() throws Exception {
		Reporter toCreate = MAPPER
				.readValue(fixture("fixtures/legacy/Reporter/invalid/primaryPhoneNumber/missing.json"), Reporter.class);
		Response response = resources.client().target(ROOT_RESOURCE).request()
				.accept(Api.Version.JSON_VERSION_1.getMediaType())
				.post(Entity.entity(toCreate, Api.MEDIA_TYPE_JSON_V1));
		assertThat(response.getStatus(), is(equalTo(422)));
	...
	public void failsWhenPrimaryPhoneNumberNull() throws Exception {
		Reporter toCreate = MAPPER.readValue(fixture("fixtures/legacy/Reporter/invalid/primaryPhoneNumber/null.json"),
				Reporter.class);
		Response response = resources.client().target(ROOT_RESOURCE).request()
				.accept(Api.Version.JSON_VERSION_1.getMediaType())
				.post(Entity.entity(toCreate, Api.MEDIA_TYPE_JSON_V1));
	...
	*/
	...
	public void failsWhenStateCodeTypeMissing() throws Exception {
		Reporter toCreate = MAPPER.readValue(fixture("fixtures/legacy/Reporter/invalid/stateCodeType/missing.json"),
				Reporter.class);
		Response response = resources.client().target(ROOT_RESOURCE).request()
				.accept(Api.Version.JSON_VERSION_1.getMediaType())
				.post(Entity.entity(toCreate, Api.MEDIA_TYPE_JSON_V1));
	...
	public void failsWhenStateCodeTypeNull() throws Exception {
		Reporter toCreate = MAPPER.readValue(fixture("fixtures/legacy/Reporter/invalid/stateCodeType/null.json"),
				Reporter.class);
		Response response = resources.client().target(ROOT_RESOURCE).request()
				.accept(Api.Version.JSON_VERSION_1.getMediaType())
				.post(Entity.entity(toCreate, Api.MEDIA_TYPE_JSON_V1));
	...
	public void failsWhenStreetNameMissing() throws Exception {
		Reporter toCreate = MAPPER.readValue(fixture("fixtures/legacy/Reporter/invalid/streetName/missing.json"),
				Reporter.class);
		Response response = resources.client().target(ROOT_RESOURCE).request()
				.accept(Api.Version.JSON_VERSION_1.getMediaType())
				.post(Entity.entity(toCreate, Api.MEDIA_TYPE_JSON_V1));
	...
	public void failsWhenStreetNameNull() throws Exception {
		Reporter toCreate = MAPPER.readValue(fixture("fixtures/legacy/Reporter/invalid/streetName/null.json"),
				Reporter.class);
		Response response = resources.client().target(ROOT_RESOURCE).request()
				.accept(Api.Version.JSON_VERSION_1.getMediaType())
				.post(Entity.entity(toCreate, Api.MEDIA_TYPE_JSON_V1));
	...
	public void failsWhenStreetNameEmpty() throws Exception {
		Reporter toCreate = MAPPER.readValue(fixture("fixtures/legacy/Reporter/invalid/streetName/empty.json"),
				Reporter.class);
		Response response = resources.client().target(ROOT_RESOURCE).request()
				.accept(Api.Version.JSON_VERSION_1.getMediaType())
				.post(Entity.entity(toCreate, Api.MEDIA_TYPE_JSON_V1));
	...
	public void failsWhenStreetNameTooLong() throws Exception {
		Reporter toCreate = MAPPER.readValue(fixture("fixtures/legacy/Reporter/invalid/streetName/tooLong.json"),
				Reporter.class);
		Response response = resources.client().target(ROOT_RESOURCE).request()
				.accept(Api.Version.JSON_VERSION_1.getMediaType())
				.post(Entity.entity(toCreate, Api.MEDIA_TYPE_JSON_V1));
		assertThat(response.getStatus(), is(equalTo(422)));
		assertThat(response.readEntity(String.class).indexOf("streetName size must be between 1 and 40"),
				is(greaterThanOrEqualTo(0)));
	}
	...
	public void failsWhenStreetNumberMissing() throws Exception {
		Reporter toCreate = MAPPER.readValue(fixture("fixtures/legacy/Reporter/invalid/streetNumber/missing.json"),
				Reporter.class);
		Response response = resources.client().target(ROOT_RESOURCE).request()
				.accept(Api.Version.JSON_VERSION_1.getMediaType())
				.post(Entity.entity(toCreate, Api.MEDIA_TYPE_JSON_V1));
	...
	public void failsWhenStreetNumberNull() throws Exception {
		Reporter toCreate = MAPPER.readValue(fixture("fixtures/legacy/Reporter/invalid/streetNumber/null.json"),
				Reporter.class);
		Response response = resources.client().target(ROOT_RESOURCE).request()
				.accept(Api.Version.JSON_VERSION_1.getMediaType())
				.post(Entity.entity(toCreate, Api.MEDIA_TYPE_JSON_V1));
	...
	public void failsWhenStreetNumberEmpty() throws Exception {
		Reporter toCreate = MAPPER.readValue(fixture("fixtures/legacy/Reporter/invalid/streetNumber/empty.json"),
				Reporter.class);
		Response response = resources.client().target(ROOT_RESOURCE).request()
				.accept(Api.Version.JSON_VERSION_1.getMediaType())
				.post(Entity.entity(toCreate, Api.MEDIA_TYPE_JSON_V1));
	...
	public void failsWhenStreetNumberTooLong() throws Exception {
		Reporter toCreate = MAPPER.readValue(fixture("fixtures/legacy/Reporter/invalid/streetNumber/tooLong.json"),
				Reporter.class);
		Response response = resources.client().target(ROOT_RESOURCE).request()
				.accept(Api.Version.JSON_VERSION_1.getMediaType())
				.post(Entity.entity(toCreate, Api.MEDIA_TYPE_JSON_V1));
		assertThat(response.getStatus(), is(equalTo(422)));
		assertThat(response.readEntity(String.class).indexOf("streetNumber size must be between 1 and 10"),
				is(greaterThanOrEqualTo(0)));
	}
	...
	public void failsWhenSuffixTitleDescriptionMissing() throws Exception {
		Reporter toCreate = MAPPER.readValue(
				fixture("fixtures/legacy/Reporter/invalid/suffixTitleDescription/missing.json"), Reporter.class);
		Response response = resources.client().target(ROOT_RESOURCE).request()
				.accept(Api.Version.JSON_VERSION_1.getMediaType())
				.post(Entity.entity(toCreate, Api.MEDIA_TYPE_JSON_V1));
		assertThat(response.getStatus(), is(equalTo(422)));
		assertThat(response.readEntity(String.class).indexOf("suffixTitleDescription may not be empty"),
				is(greaterThanOrEqualTo(0)));
	}
	...
	public void failsWhenSuffixTitleDescriptionNull() throws Exception {
		Reporter toCreate = MAPPER.readValue(
				fixture("fixtures/legacy/Reporter/invalid/suffixTitleDescription/null.json"), Reporter.class);
		Response response = resources.client().target(ROOT_RESOURCE).request()
				.accept(Api.Version.JSON_VERSION_1.getMediaType())
				.post(Entity.entity(toCreate, Api.MEDIA_TYPE_JSON_V1));
		assertThat(response.getStatus(), is(equalTo(422)));
	...
	public void failsWhenSuffixTitleDescriptionEmpty() throws Exception {
		Reporter toCreate = MAPPER.readValue(
				fixture("fixtures/legacy/Reporter/invalid/suffixTitleDescription/empty.json"), Reporter.class);
		Response response = resources.client().target(ROOT_RESOURCE).request()
				.accept(Api.Version.JSON_VERSION_1.getMediaType())
				.post(Entity.entity(toCreate, Api.MEDIA_TYPE_JSON_V1));
		assertThat(response.getStatus(), is(equalTo(422)));
	...
	public void failsWhenSuffixTitleDescriptionTooLong() throws Exception {
		Reporter toCreate = MAPPER.readValue(
				fixture("fixtures/legacy/Reporter/invalid/suffixTitleDescription/tooLong.json"), Reporter.class);
		Response response = resources.client().target(ROOT_RESOURCE).request()
				.accept(Api.Version.JSON_VERSION_1.getMediaType())
				.post(Entity.entity(toCreate, Api.MEDIA_TYPE_JSON_V1));
		assertThat(response.getStatus(), is(equalTo(422)));
	...
	*/
	...
	public void failsWhenReferralIdMissing() throws Exception {
		Reporter toCreate = MAPPER.readValue(fixture("fixtures/legacy/Reporter/invalid/referralId/missing.json"),
				Reporter.class);
		Response response = resources.client().target(ROOT_RESOURCE).request()
				.accept(Api.Version.JSON_VERSION_1.getMediaType())
				.post(Entity.entity(toCreate, Api.MEDIA_TYPE_JSON_V1));
	...
	public void failsWhenReferralIdNull() throws Exception {
		Reporter toCreate = MAPPER.readValue(fixture("fixtures/legacy/Reporter/invalid/referralId/null.json"),
				Reporter.class);
		Response response = resources.client().target(ROOT_RESOURCE).request()
				.accept(Api.Version.JSON_VERSION_1.getMediaType())
				.post(Entity.entity(toCreate, Api.MEDIA_TYPE_JSON_V1));
	...
	public void failsWhenReferralIdEmpty() throws Exception {
		Reporter toCreate = MAPPER.readValue(fixture("fixtures/legacy/Reporter/invalid/referralId/empty.json"),
				Reporter.class);
		Response response = resources.client().target(ROOT_RESOURCE).request()
				.accept(Api.Version.JSON_VERSION_1.getMediaType())
				.post(Entity.entity(toCreate, Api.MEDIA_TYPE_JSON_V1));
	...
	public void failsWhenReferralIdTooLong() throws Exception {
		Reporter toCreate = MAPPER.readValue(fixture("fixtures/legacy/Reporter/invalid/referralId/tooLong.json"),
				Reporter.class);
		Response response = resources.client().target(ROOT_RESOURCE).request()
				.accept(Api.Version.JSON_VERSION_1.getMediaType())
				.post(Entity.entity(toCreate, Api.MEDIA_TYPE_JSON_V1));
		assertThat(response.getStatus(), is(equalTo(422)));
		assertThat(response.readEntity(String.class).indexOf("referralId size must be between 1 and 10"),
				is(greaterThanOrEqualTo(0)));
	}
	...
	public void successWhenLawEnforcementIdEmpty() throws Exception {
		Reporter toCreate = MAPPER.readValue(fixture("fixtures/legacy/Reporter/invalid/lawEnforcementId/empty.json"),
				Reporter.class);
		Response response = resources.client().target(ROOT_RESOURCE).request()
				.accept(Api.Version.JSON_VERSION_1.getMediaType())
				.post(Entity.entity(toCreate, Api.MEDIA_TYPE_JSON_V1));
	...
	public void successWhenLawEnforcementIdNull() throws Exception {
		Reporter toCreate = MAPPER.readValue(fixture("fixtures/legacy/Reporter/invalid/lawEnforcementId/null.json"),
				Reporter.class);
		Response response = resources.client().target(ROOT_RESOURCE).request()
				.accept(Api.Version.JSON_VERSION_1.getMediaType())
				.post(Entity.entity(toCreate, Api.MEDIA_TYPE_JSON_V1));
	...
	public void failsWhenLawEnforcementIdTooLong() throws Exception {
		Reporter toCreate = MAPPER.readValue(fixture("fixtures/legacy/Reporter/invalid/lawEnforcementId/tooLong.json"),
				Reporter.class);
		Response response = resources.client().target(ROOT_RESOURCE).request()
				.accept(Api.Version.JSON_VERSION_1.getMediaType())
				.post(Entity.entity(toCreate, Api.MEDIA_TYPE_JSON_V1));
		assertThat(response.getStatus(), is(equalTo(422)));
		assertThat(response.readEntity(String.class).indexOf("lawEnforcementId size must be between 0 and 10"),
				is(greaterThanOrEqualTo(0)));
	}
	...
	public void failsWhenZipSuffixNumberMissing() throws Exception {
		Reporter toCreate = MAPPER.readValue(fixture("fixtures/legacy/Reporter/invalid/zipSuffixNumber/missing.json"),
				Reporter.class);
		Response response = resources.client().target(ROOT_RESOURCE).request()
				.accept(Api.Version.JSON_VERSION_1.getMediaType())
				.post(Entity.entity(toCreate, Api.MEDIA_TYPE_JSON_V1));
	...
	public void failsWhenZipSuffixNumberNull() throws Exception {
		Reporter toCreate = MAPPER.readValue(fixture("fixtures/legacy/Reporter/invalid/zipSuffixNumber/null.json"),
				Reporter.class);
		Response response = resources.client().target(ROOT_RESOURCE).request()
				.accept(Api.Version.JSON_VERSION_1.getMediaType())
				.post(Entity.entity(toCreate, Api.MEDIA_TYPE_JSON_V1));
	...
	public void failsWhenCountySpecificCodeMissing() throws Exception {
		Reporter toCreate = MAPPER
				.readValue(fixture("fixtures/legacy/Reporter/invalid/countySpecificCode/missing.json"), Reporter.class);
		Response response = resources.client().target(ROOT_RESOURCE).request()
				.accept(Api.Version.JSON_VERSION_1.getMediaType())
				.post(Entity.entity(toCreate, Api.MEDIA_TYPE_JSON_V1));
		assertThat(response.getStatus(), is(equalTo(422)));
	...
	public void failsWhenCountySpecificCodeNull() throws Exception {
		Reporter toCreate = MAPPER.readValue(fixture("fixtures/legacy/Reporter/invalid/countySpecificCode/null.json"),
				Reporter.class);
		Response response = resources.client().target(ROOT_RESOURCE).request()
				.accept(Api.Version.JSON_VERSION_1.getMediaType())
				.post(Entity.entity(toCreate, Api.MEDIA_TYPE_JSON_V1));
	...
	public void failsWhenCountySpecificCodeEmpty() throws Exception {
		Reporter toCreate = MAPPER.readValue(fixture("fixtures/legacy/Reporter/invalid/countySpecificCode/empty.json"),
				Reporter.class);
		Response response = resources.client().target(ROOT_RESOURCE).request()
				.accept(Api.Version.JSON_VERSION_1.getMediaType())
				.post(Entity.entity(toCreate, Api.MEDIA_TYPE_JSON_V1));
	...
	public void failsWhenCountySpecificCodeTooLong() throws Exception {
		Reporter toCreate = MAPPER
				.readValue(fixture("fixtures/legacy/Reporter/invalid/countySpecificCode/tooLong.json"), Reporter.class);
		Response response = resources.client().target(ROOT_RESOURCE).request()
				.accept(Api.Version.JSON_VERSION_1.getMediaType())
				.post(Entity.entity(toCreate, Api.MEDIA_TYPE_JSON_V1));
		assertThat(response.getStatus(), is(equalTo(422)));
	...
	private Reporter validReporter() {
		return new Reporter("A123", "ABC", new Short((short) 12), new Short((short) 34), false, "ABC123", "DEF",
				"2000-01-01", false, "John", "Smith", false, 123, new BigDecimal(1234567), "A", "ABC123",
				new BigDecimal(1234567), 123, new Short((short) 1234), "ABC STREET", "123", "AB", 12345, "DEF", "DEF",
				new Short((short) 1234), "AB");
	}
}
