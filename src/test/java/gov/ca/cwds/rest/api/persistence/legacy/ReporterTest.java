...
public class ReporterTest {
	...
	public void domainReferralClientLastUpdateConstructorTest() throws Exception {
		gov.ca.cwds.rest.api.domain.Reporter domain = new gov.ca.cwds.rest.api.domain.Reporter(badgeNumber, cityName,
				...
				namePrefixDescription, primaryPhoneNumber, primaryPhoneExtensionNumber, stateCodeType, streetName,
				streetNumber, suffixTitleDescription, zipNumber, referralId, lawEnforcementId, zipSuffixNumber,
				countySpecificCode);
		...
		assertThat(persistent.getColltrClientRptrReltnshpType(), is(equalTo(colltrClientRptrReltnshpType)));
		...
		assertThat(persistent.getMessagePhoneExtensionNumber(), is(equalTo(messagePhoneExtensionNumber)));
