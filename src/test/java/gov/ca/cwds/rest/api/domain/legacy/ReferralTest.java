...
public class ReferralTest {
  ...
  private static final ReferralResourceImpl mockedReferralResource =
      mock(ReferralResourceImpl.class);
  ...
  public void persistentObjectConstructorTest() throws Exception {
    Referral domain =
        new Referral(id, additionalInfoIncludedCode, anonymousReporterIndicator,
            applicationForPetitionIndicator, approvalNumber, approvalStatusType,
            caretakersPerpetratorCode, closureDate, communicationMethodType,
    ...
    gov.ca.cwds.rest.api.persistence.legacy.Referral persistent =
        new gov.ca.cwds.rest.api.persistence.legacy.Referral(domain, "lastUpdatedId");
    ...
    assertThat(totest.getAdditionalInfoIncludedCode(),
        is(equalTo(persistent.getAdditionalInfoIncludedCode())));
    assertThat(totest.getAnonymousReporterIndicator(),
        is(equalTo(DomainObject.uncookBooleanString(persistent.getAnonymousReporterIndicator()))));
    assertThat(
        totest.getApplicationForPetitionIndicator(),
        is(equalTo(DomainObject.uncookBooleanString(persistent.getApplicationForPetitionIndicator()))));
    ...
    assertThat(totest.getCaretakersPerpetratorCode(),
        is(equalTo(persistent.getCaretakersPerpetratorCode())));
    ...
    assertThat(totest.getFamilyAwarenessIndicator(),
        is(equalTo(DomainObject.uncookBooleanString(persistent.getFamilyAwarenessIndicator()))));
    ...
    assertThat(totest.getLegalRightsNoticeIndicator(),
        is(equalTo(DomainObject.uncookBooleanString(persistent.getLegalRightsNoticeIndicator()))));
    ...
    assertThat(
        totest.getSpecialProjectReferralIndicator(),
        is(equalTo(DomainObject.uncookBooleanString(persistent.getSpecialProjectReferralIndicator()))));
    ...
    assertThat(totest.getHomelessIndicator(),
        is(equalTo(DomainObject.uncookBooleanString(persistent.getHomelessIndicator()))));
    assertThat(
        totest.getFamilyRefusedServicesIndicator(),
        is(equalTo(DomainObject.uncookBooleanString(persistent.getFamilyRefusedServicesIndicator()))));
  ...
  public void serializesToJSON() throws Exception {
    final String expected =
        MAPPER.writeValueAsString(MAPPER.readValue(
            fixture("fixtures/legacy/Referral/valid/valid.json"), Referral.class));
  ...
  public void successfulWithOptionalsNotIncluded() throws Exception {
    Referral toCreate =
        MAPPER.readValue(fixture("fixtures/legacy/Referral/valid/optionalsNotIncluded.json"),
            Referral.class);
    assertThat(
        resources.client().target(ROOT_RESOURCE).request()
            .accept(Api.Version.JSON_VERSION_1.getMediaType())
  ...
  public void failsWhenIdMissing() throws Exception {
    Referral toCreate =
        MAPPER.readValue(fixture("fixtures/legacy/Referral/invalid/id/missing.json"),
            Referral.class);
    Response response =
        resources.client().target(ROOT_RESOURCE).request()
            .accept(Api.Version.JSON_VERSION_1.getMediaType())
  ...
  public void failsWhenIdNull() throws Exception {
    Referral toCreate =
        MAPPER.readValue(fixture("fixtures/legacy/Referral/invalid/id/null.json"), Referral.class);
    Response response =
        resources.client().target(ROOT_RESOURCE).request()
            .accept(Api.Version.JSON_VERSION_1.getMediaType())
            .post(Entity.entity(toCreate, Api.MEDIA_TYPE_JSON_V1));
  ...
  public void failsWhenIdEmpty() throws Exception {
    Referral toCreate =
        MAPPER.readValue(fixture("fixtures/legacy/Referral/invalid/id/empty.json"), Referral.class);
    Response response =
        resources.client().target(ROOT_RESOURCE).request()
            .accept(Api.Version.JSON_VERSION_1.getMediaType())
            .post(Entity.entity(toCreate, Api.MEDIA_TYPE_JSON_V1));
  ...
  public void failsWhenIdTooLong() throws Exception {
    Referral toCreate =
        MAPPER.readValue(fixture("fixtures/legacy/Referral/invalid/id/tooLong.json"),
            Referral.class);
    Response response =
        resources.client().target(ROOT_RESOURCE).request()
            .accept(Api.Version.JSON_VERSION_1.getMediaType())
  ...
  public void failsWhenAdditionalInfoIncludedCodeMissing() throws Exception {
    Referral toCreate =
        MAPPER.readValue(
            fixture("fixtures/legacy/Referral/invalid/additionalInfoIncludedCode/missing.json"),
            Referral.class);
    Response response =
        resources.client().target(ROOT_RESOURCE).request()
            .accept(Api.Version.JSON_VERSION_1.getMediaType())
    ...
    assertThat(response.getStatus(), is(equalTo(422)));
    assertThat(
        response.readEntity(String.class).indexOf("additionalInfoIncludedCode may not be empty"),
        is(greaterThanOrEqualTo(0)));
  }
  ...
  public void failsWhenAdditionalInfoIncludedCodeNull() throws Exception {
    Referral toCreate =
        MAPPER.readValue(
            fixture("fixtures/legacy/Referral/invalid/additionalInfoIncludedCode/null.json"),
            Referral.class);
    Response response =
        resources.client().target(ROOT_RESOURCE).request()
            .accept(Api.Version.JSON_VERSION_1.getMediaType())
  ...
  public void failsWhenAdditionalInfoIncludedCodeEmpty() throws Exception {
    Referral toCreate =
        MAPPER.readValue(
            fixture("fixtures/legacy/Referral/invalid/additionalInfoIncludedCode/empty.json"),
            Referral.class);
    Response response =
        resources.client().target(ROOT_RESOURCE).request()
            .accept(Api.Version.JSON_VERSION_1.getMediaType())
  ...
  public void failsWhenAdditionalInfoIncludedCodeTooLong() throws Exception {
    Referral toCreate =
        MAPPER.readValue(
            fixture("fixtures/legacy/Referral/invalid/additionalInfoIncludedCode/tooLong.json"),
            Referral.class);
    Response response =
        resources.client().target(ROOT_RESOURCE).request()
            .accept(Api.Version.JSON_VERSION_1.getMediaType())
    ...
    assertThat(response.getStatus(), is(equalTo(422)));
    assertThat(
        response.readEntity(String.class).indexOf("additionalInfoIncludedCode size must be 1"),
        is(greaterThanOrEqualTo(0)));
  }
  ...
  public void failsWhenAnonymousReporterIndicatorMissing() throws Exception {
    Referral toCreate =
        MAPPER.readValue(
            fixture("fixtures/legacy/Referral/invalid/anonymousReporterIndicator/missing.json"),
            Referral.class);
    Response response =
        resources.client().target(ROOT_RESOURCE).request()
            .accept(Api.Version.JSON_VERSION_1.getMediaType())
  ...
  public void failsWhenAnonymousReporterIndicatorNull() throws Exception {
    Referral toCreate =
        MAPPER.readValue(
            fixture("fixtures/legacy/Referral/invalid/anonymousReporterIndicator/null.json"),
            Referral.class);
    Response response =
        resources.client().target(ROOT_RESOURCE).request()
            .accept(Api.Version.JSON_VERSION_1.getMediaType())
  ...
  public void failsWhenAnonymousReporterIndicatorEmpty() throws Exception {
    Referral toCreate =
        MAPPER.readValue(
            fixture("fixtures/legacy/Referral/invalid/anonymousReporterIndicator/empty.json"),
            Referral.class);
    Response response =
        resources.client().target(ROOT_RESOURCE).request()
            .accept(Api.Version.JSON_VERSION_1.getMediaType())
  ...
  public void failsWhenApplicationForPetitionIndicatorMissing() throws Exception {
    ...
    assertThat(
        response.readEntity(String.class)
            .indexOf("applicationForPetitionIndicator may not be null"),
        is(greaterThanOrEqualTo(0)));
  }
  ...
  public void failsWhenApplicationForPetitionIndicatorNull() throws Exception {
    Referral toCreate =
        MAPPER.readValue(
            fixture("fixtures/legacy/Referral/invalid/applicationForPetitionIndicator/null.json"),
            Referral.class);
    Response response =
        resources.client().target(ROOT_RESOURCE).request()
            .accept(Api.Version.JSON_VERSION_1.getMediaType())
  ...
  public void failsWhenApplicationForPetitionIndicatorEmpty() throws Exception {
    Referral toCreate =
        MAPPER.readValue(
            fixture("fixtures/legacy/Referral/invalid/applicationForPetitionIndicator/empty.json"),
            Referral.class);
    Response response =
        resources.client().target(ROOT_RESOURCE).request()
            .accept(Api.Version.JSON_VERSION_1.getMediaType())
  ...
  public void failsWhenApprovalNumberTooLong() throws Exception {
    Referral toCreate =
        MAPPER.readValue(fixture("fixtures/legacy/Referral/invalid/approvalNumber/tooLong.json"),
            Referral.class);
    Response response =
        resources.client().target(ROOT_RESOURCE).request()
            .accept(Api.Version.JSON_VERSION_1.getMediaType())
  ...
  public void failsWhenApprovalStatusTypeMissing() throws Exception {
    Referral toCreate =
        MAPPER.readValue(
            fixture("fixtures/legacy/Referral/invalid/approvalStatusType/missing.json"),
            Referral.class);
    Response response =
        resources.client().target(ROOT_RESOURCE).request()
            .accept(Api.Version.JSON_VERSION_1.getMediaType())
  ...
  public void failsWhenApprovalStatusTypeNull() throws Exception {
    Referral toCreate =
        MAPPER.readValue(fixture("fixtures/legacy/Referral/invalid/approvalStatusType/null.json"),
            Referral.class);
    Response response =
        resources.client().target(ROOT_RESOURCE).request()
            .accept(Api.Version.JSON_VERSION_1.getMediaType())
  ...
  public void failsWhenCaretakersPerpetratorCodeMissing() throws Exception {
    Referral toCreate =
        MAPPER.readValue(
            fixture("fixtures/legacy/Referral/invalid/caretakersPerpetratorCode/missing.json"),
            Referral.class);
    Response response =
        resources.client().target(ROOT_RESOURCE).request()
            .accept(Api.Version.JSON_VERSION_1.getMediaType())
    ...
    assertThat(response.getStatus(), is(equalTo(422)));
    assertThat(
        response.readEntity(String.class).indexOf("caretakersPerpetratorCode may not be empty"),
        is(greaterThanOrEqualTo(0)));
  }
  ...
  public void failsWhenCaretakersPerpetratorCodeNull() throws Exception {
    Referral toCreate =
        MAPPER.readValue(
            fixture("fixtures/legacy/Referral/invalid/caretakersPerpetratorCode/null.json"),
            Referral.class);
    Response response =
        resources.client().target(ROOT_RESOURCE).request()
            .accept(Api.Version.JSON_VERSION_1.getMediaType())
  ...
  public void failsWhenCaretakersPerpetratorCodeEmpty() throws Exception {
    Referral toCreate =
        MAPPER.readValue(
            fixture("fixtures/legacy/Referral/invalid/caretakersPerpetratorCode/empty.json"),
            Referral.class);
    Response response =
        resources.client().target(ROOT_RESOURCE).request()
            .accept(Api.Version.JSON_VERSION_1.getMediaType())
  ...
  public void failsWhenCaretakersPerpetratorCodeTooLong() throws Exception {
    Referral toCreate =
        MAPPER.readValue(
            fixture("fixtures/legacy/Referral/invalid/caretakersPerpetratorCode/tooLong.json"),
            Referral.class);
    Response response =
        resources.client().target(ROOT_RESOURCE).request()
            .accept(Api.Version.JSON_VERSION_1.getMediaType())
    ...
    assertThat(response.readEntity(String.class)
        .indexOf("caretakersPerpetratorCode size must be 1"), is(greaterThanOrEqualTo(0)));
  }
  ...
  public void failsWhenClosureDateWrongFormat() throws Exception {
    Referral toCreate =
        MAPPER.readValue(fixture("fixtures/legacy/Referral/invalid/closureDate/wrongFormat.json"),
            Referral.class);
    Response response =
        resources.client().target(ROOT_RESOURCE).request()
            .accept(Api.Version.JSON_VERSION_1.getMediaType())
    ...
    assertThat(
        response.readEntity(String.class)
            .indexOf("closureDate must be in the format of yyyy-MM-dd"),
        is(greaterThanOrEqualTo(0)));
  }
  ...
  public void failsWhenCommunicationMethodTypeMissing() throws Exception {
    Referral toCreate =
        MAPPER.readValue(
            fixture("fixtures/legacy/Referral/invalid/communicationMethodType/missing.json"),
            Referral.class);
    Response response =
        resources.client().target(ROOT_RESOURCE).request()
            .accept(Api.Version.JSON_VERSION_1.getMediaType())
  ...
  public void failsWhenCommunicationMethodTypeNull() throws Exception {
    Referral toCreate =
        MAPPER.readValue(
            fixture("fixtures/legacy/Referral/invalid/communicationMethodType/null.json"),
            Referral.class);
    Response response =
        resources.client().target(ROOT_RESOURCE).request()
            .accept(Api.Version.JSON_VERSION_1.getMediaType())
  ...
  public void failsWhenCurrentLocationOfChildrenTooLong() throws Exception {
    Referral toCreate =
        MAPPER.readValue(
            fixture("fixtures/legacy/Referral/invalid/currentLocationOfChildren/tooLong.json"),
            Referral.class);
    Response response =
        resources.client().target(ROOT_RESOURCE).request()
            .accept(Api.Version.JSON_VERSION_1.getMediaType())
    ...
    assertThat(
        response.readEntity(String.class).indexOf(
            "currentLocationOfChildren size must be between 0 and 10"), is(greaterThanOrEqualTo(0)));
  }
  ...
  public void failsWhenDrmsAllegationDescriptionDocTooLong() throws Exception {
    Referral toCreate =
        MAPPER.readValue(
            fixture("fixtures/legacy/Referral/invalid/drmsAllegationDescriptionDoc/tooLong.json"),
            Referral.class);
    Response response =
        resources.client().target(ROOT_RESOURCE).request()
            .accept(Api.Version.JSON_VERSION_1.getMediaType())
    ...
    assertThat(
        response.readEntity(String.class).indexOf(
            "drmsAllegationDescriptionDoc size must be between 0 and 10"),
        is(greaterThanOrEqualTo(0)));
  }
  ...
  public void failsWhenDrmsErReferralDocTooLong() throws Exception {
    Referral toCreate =
        MAPPER.readValue(
            fixture("fixtures/legacy/Referral/invalid/drmsErReferralDoc/tooLong.json"),
            Referral.class);
    Response response =
        resources.client().target(ROOT_RESOURCE).request()
            .accept(Api.Version.JSON_VERSION_1.getMediaType())
    ...
    assertThat(
        response.readEntity(String.class)
            .indexOf("drmsErReferralDoc size must be between 0 and 10"),
        is(greaterThanOrEqualTo(0)));
  }
  ...
  public void failsWhenDrmsInvestigationDocTooLong() throws Exception {
    Referral toCreate =
        MAPPER.readValue(
            fixture("fixtures/legacy/Referral/invalid/drmsInvestigationDoc/tooLong.json"),
            Referral.class);
    Response response =
        resources.client().target(ROOT_RESOURCE).request()
            .accept(Api.Version.JSON_VERSION_1.getMediaType())
  ...
  public void failsWhenFiledSuspectedChildAbuseReporttoLawEnforcementIndicatorMissing()
    ...
    assertThat(
        response.readEntity(String.class).indexOf(
            "filedSuspectedChildAbuseReporttoLawEnforcementIndicator may not be null"),
        is(greaterThanOrEqualTo(0)));
  }
  ...
  public void failsWhenFamilyAwarenessIndicatorMissing() throws Exception {
    Referral toCreate =
        MAPPER.readValue(
            fixture("fixtures/legacy/Referral/invalid/familyAwarenessIndicator/missing.json"),
            Referral.class);
    Response response =
        resources.client().target(ROOT_RESOURCE).request()
            .accept(Api.Version.JSON_VERSION_1.getMediaType())
    ...
    assertThat(response.getStatus(), is(equalTo(422)));
    assertThat(response.readEntity(String.class)
        .indexOf("familyAwarenessIndicator may not be null"), is(greaterThanOrEqualTo(0)));
  }
  ...
  public void failsWhenFamilyAwarenessIndicatorNull() throws Exception {
    Referral toCreate =
        MAPPER.readValue(
            fixture("fixtures/legacy/Referral/invalid/familyAwarenessIndicator/null.json"),
            Referral.class);
    Response response =
        resources.client().target(ROOT_RESOURCE).request()
            .accept(Api.Version.JSON_VERSION_1.getMediaType())
  ...
  public void failsWhenFamilyAwarenessIndicatorEmpty() throws Exception {
    Referral toCreate =
        MAPPER.readValue(
            fixture("fixtures/legacy/Referral/invalid/familyAwarenessIndicator/empty.json"),
            Referral.class);
    Response response =
        resources.client().target(ROOT_RESOURCE).request()
            .accept(Api.Version.JSON_VERSION_1.getMediaType())
  ...
  public void failsWhenGovtEntityTypeMissing() throws Exception {
    Referral toCreate =
        MAPPER.readValue(fixture("fixtures/legacy/Referral/invalid/govtEntityType/missing.json"),
            Referral.class);
    Response response =
        resources.client().target(ROOT_RESOURCE).request()
            .accept(Api.Version.JSON_VERSION_1.getMediaType())
  ...
  public void failsWhenGovtEntityTypeNull() throws Exception {
    Referral toCreate =
        MAPPER.readValue(fixture("fixtures/legacy/Referral/invalid/govtEntityType/null.json"),
            Referral.class);
    Response response =
        resources.client().target(ROOT_RESOURCE).request()
            .accept(Api.Version.JSON_VERSION_1.getMediaType())
  ...
  public void failsWhenLegalDefinitionCodeMissing() throws Exception {
    Referral toCreate =
        MAPPER.readValue(
            fixture("fixtures/legacy/Referral/invalid/legalDefinitionCode/missing.json"),
            Referral.class);
    Response response =
        resources.client().target(ROOT_RESOURCE).request()
            .accept(Api.Version.JSON_VERSION_1.getMediaType())
  ...
  public void failsWhenLegalDefinitionCodeNull() throws Exception {
    Referral toCreate =
        MAPPER.readValue(fixture("fixtures/legacy/Referral/invalid/legalDefinitionCode/null.json"),
            Referral.class);
    Response response =
        resources.client().target(ROOT_RESOURCE).request()
            .accept(Api.Version.JSON_VERSION_1.getMediaType())
  ...
  public void failsWhenLegalDefinitionCodeEmpty() throws Exception {
    Referral toCreate =
        MAPPER.readValue(
            fixture("fixtures/legacy/Referral/invalid/legalDefinitionCode/empty.json"),
            Referral.class);
    Response response =
        resources.client().target(ROOT_RESOURCE).request()
            .accept(Api.Version.JSON_VERSION_1.getMediaType())
  ...
  public void failsWhenLegalDefinitionCodeTooLong() throws Exception {
    Referral toCreate =
        MAPPER.readValue(
            fixture("fixtures/legacy/Referral/invalid/legalDefinitionCode/tooLong.json"),
            Referral.class);
    Response response =
        resources.client().target(ROOT_RESOURCE).request()
            .accept(Api.Version.JSON_VERSION_1.getMediaType())
  ...
  public void failsWhenLegalRightsNoticeIndicatorMissing() throws Exception {
    Referral toCreate =
        MAPPER.readValue(
            fixture("fixtures/legacy/Referral/invalid/legalRightsNoticeIndicator/missing.json"),
            Referral.class);
    Response response =
        resources.client().target(ROOT_RESOURCE).request()
            .accept(Api.Version.JSON_VERSION_1.getMediaType())
  ...
  public void failsWhenLegalRightsNoticeIndicatorNull() throws Exception {
    Referral toCreate =
        MAPPER.readValue(
            fixture("fixtures/legacy/Referral/invalid/legalRightsNoticeIndicator/null.json"),
            Referral.class);
    Response response =
        resources.client().target(ROOT_RESOURCE).request()
            .accept(Api.Version.JSON_VERSION_1.getMediaType())
  ...
  public void failsWhenLegalRightsNoticeIndicatorEmpty() throws Exception {
    Referral toCreate =
        MAPPER.readValue(
            fixture("fixtures/legacy/Referral/invalid/legalRightsNoticeIndicator/empty.json"),
            Referral.class);
    Response response =
        resources.client().target(ROOT_RESOURCE).request()
            .accept(Api.Version.JSON_VERSION_1.getMediaType())
  ...
  public void failsWhenLimitedAccessCodeMissing() throws Exception {
    Referral toCreate =
        MAPPER.readValue(
            fixture("fixtures/legacy/Referral/invalid/limitedAccessCode/missing.json"),
            Referral.class);
    Response response =
        resources.client().target(ROOT_RESOURCE).request()
            .accept(Api.Version.JSON_VERSION_1.getMediaType())
  ...
  public void failsWhenLimitedAccessCodeNull() throws Exception {
    Referral toCreate =
        MAPPER.readValue(fixture("fixtures/legacy/Referral/invalid/limitedAccessCode/null.json"),
            Referral.class);
    Response response =
        resources.client().target(ROOT_RESOURCE).request()
            .accept(Api.Version.JSON_VERSION_1.getMediaType())
  ...
  public void failsWhenLimitedAccessCodeEmpty() throws Exception {
    Referral toCreate =
        MAPPER.readValue(fixture("fixtures/legacy/Referral/invalid/limitedAccessCode/empty.json"),
            Referral.class);
    Response response =
        resources.client().target(ROOT_RESOURCE).request()
            .accept(Api.Version.JSON_VERSION_1.getMediaType())
  ...
  public void failsWhenLimitedAccessCodeTooLong() throws Exception {
    Referral toCreate =
        MAPPER.readValue(
            fixture("fixtures/legacy/Referral/invalid/limitedAccessCode/tooLong.json"),
            Referral.class);
    Response response =
        resources.client().target(ROOT_RESOURCE).request()
            .accept(Api.Version.JSON_VERSION_1.getMediaType())
  ...
  public void failsWhenLimitedAccessCodeNotValidValue() throws Exception {
    Referral toCreate =
        MAPPER.readValue(
            fixture("fixtures/legacy/Referral/invalid/limitedAccessCode/notValidValue.json"),
            Referral.class);
    Response response =
        resources.client().target(ROOT_RESOURCE).request()
            .accept(Api.Version.JSON_VERSION_1.getMediaType())
  ...
  public void failsWhenMandatedCrossReportReceivedDateWrongFormat() throws Exception {
    ...
    assertThat(
        response.readEntity(String.class).indexOf(
            "mandatedCrossReportReceivedDate must be in the format of yyyy-MM-dd"),
        is(greaterThanOrEqualTo(0)));
  }
  ...
  public void failsWhenReferralNameMissing() throws Exception {
    Referral toCreate =
        MAPPER.readValue(fixture("fixtures/legacy/Referral/invalid/referralName/missing.json"),
            Referral.class);
    Response response =
        resources.client().target(ROOT_RESOURCE).request()
            .accept(Api.Version.JSON_VERSION_1.getMediaType())
  ...
  public void failsWhenReferralNameNull() throws Exception {
    Referral toCreate =
        MAPPER.readValue(fixture("fixtures/legacy/Referral/invalid/referralName/null.json"),
            Referral.class);
    Response response =
        resources.client().target(ROOT_RESOURCE).request()
            .accept(Api.Version.JSON_VERSION_1.getMediaType())
  ...
  public void failsWhenReferralNameEmpty() throws Exception {
    Referral toCreate =
        MAPPER.readValue(fixture("fixtures/legacy/Referral/invalid/referralName/empty.json"),
            Referral.class);
    Response response =
        resources.client().target(ROOT_RESOURCE).request()
            .accept(Api.Version.JSON_VERSION_1.getMediaType())
  ...
  public void failsWhenReferralNameTooLong() throws Exception {
    Referral toCreate =
        MAPPER.readValue(fixture("fixtures/legacy/Referral/invalid/referralName/tooLong.json"),
            Referral.class);
    Response response =
        resources.client().target(ROOT_RESOURCE).request()
            .accept(Api.Version.JSON_VERSION_1.getMediaType())
    ...
    assertThat(response.getStatus(), is(equalTo(422)));
    assertThat(
        response.readEntity(String.class).indexOf("referralName size must be between 1 and 35"),
        is(greaterThanOrEqualTo(0)));
  }
  ...
  public void failsWhenOpenAdequateCaseCodeMissing() throws Exception {
    Referral toCreate =
        MAPPER.readValue(
            fixture("fixtures/legacy/Referral/invalid/openAdequateCaseCode/missing.json"),
            Referral.class);
    Response response =
        resources.client().target(ROOT_RESOURCE).request()
            .accept(Api.Version.JSON_VERSION_1.getMediaType())
  ...
  public void failsWhenOpenAdequateCaseCodeNull() throws Exception {
    Referral toCreate =
        MAPPER.readValue(
            fixture("fixtures/legacy/Referral/invalid/openAdequateCaseCode/null.json"),
            Referral.class);
    Response response =
        resources.client().target(ROOT_RESOURCE).request()
            .accept(Api.Version.JSON_VERSION_1.getMediaType())
  ...
  public void failsWhenOpenAdequateCaseCodeEmpty() throws Exception {
    Referral toCreate =
        MAPPER.readValue(
            fixture("fixtures/legacy/Referral/invalid/openAdequateCaseCode/empty.json"),
            Referral.class);
    Response response =
        resources.client().target(ROOT_RESOURCE).request()
            .accept(Api.Version.JSON_VERSION_1.getMediaType())
  ...
  public void failsWhenOpenAdequateCaseCodeTooLong() throws Exception {
    Referral toCreate =
        MAPPER.readValue(
            fixture("fixtures/legacy/Referral/invalid/openAdequateCaseCode/tooLong.json"),
            Referral.class);
    Response response =
        resources.client().target(ROOT_RESOURCE).request()
            .accept(Api.Version.JSON_VERSION_1.getMediaType())
  ...
  public void failsWhenReceivedDateMissing() throws Exception {
    Referral toCreate =
        MAPPER.readValue(fixture("fixtures/legacy/Referral/invalid/receivedDate/missing.json"),
            Referral.class);
    Response response =
        resources.client().target(ROOT_RESOURCE).request()
            .accept(Api.Version.JSON_VERSION_1.getMediaType())
    ...
    assertThat(
        response.readEntity(String.class).indexOf(
            "receivedDate must be in the format of yyyy-MM-dd"), is(greaterThanOrEqualTo(0)));
  }

  @Test
  public void failsWhenReceivedDateNull() throws Exception {
    Referral toCreate =
        MAPPER.readValue(fixture("fixtures/legacy/Referral/invalid/receivedDate/null.json"),
            Referral.class);
    Response response =
        resources.client().target(ROOT_RESOURCE).request()
            .accept(Api.Version.JSON_VERSION_1.getMediaType())
  ...
  public void failsWhenReceivedDateWrongFormat() throws Exception {
    Referral toCreate =
        MAPPER.readValue(fixture("fixtures/legacy/Referral/invalid/receivedDate/wrongFormat.json"),
            Referral.class);
    Response response =
        resources.client().target(ROOT_RESOURCE).request()
            .accept(Api.Version.JSON_VERSION_1.getMediaType())
  ...
  public void failsWhenReceivedTimeMissing() throws Exception {
    Referral toCreate =
        MAPPER.readValue(fixture("fixtures/legacy/Referral/invalid/receivedTime/missing.json"),
            Referral.class);
    Response response =
        resources.client().target(ROOT_RESOURCE).request()
            .accept(Api.Version.JSON_VERSION_1.getMediaType())
  ...
  public void failsWhenReceivedTimeNull() throws Exception {
    Referral toCreate =
        MAPPER.readValue(fixture("fixtures/legacy/Referral/invalid/receivedTime/null.json"),
            Referral.class);
    Response response =
        resources.client().target(ROOT_RESOURCE).request()
            .accept(Api.Version.JSON_VERSION_1.getMediaType())
  ...
  public void failsWhenReceivedTimeWrongFormat() throws Exception {
    Referral toCreate =
        MAPPER.readValue(fixture("fixtures/legacy/Referral/invalid/receivedTime/wrongFormat.json"),
            Referral.class);
    Response response =
        resources.client().target(ROOT_RESOURCE).request()
            .accept(Api.Version.JSON_VERSION_1.getMediaType())
  ...
  public void failsWhenReferralResponseTypeMissing() throws Exception {
    Referral toCreate =
        MAPPER.readValue(
            fixture("fixtures/legacy/Referral/invalid/referralResponseType/missing.json"),
            Referral.class);
    Response response =
        resources.client().target(ROOT_RESOURCE).request()
            .accept(Api.Version.JSON_VERSION_1.getMediaType())
  ...
  public void failsWhenReferralResponseTypeNull() throws Exception {
    Referral toCreate =
        MAPPER.readValue(
            fixture("fixtures/legacy/Referral/invalid/referralResponseType/null.json"),
            Referral.class);
    Response response =
        resources.client().target(ROOT_RESOURCE).request()
            .accept(Api.Version.JSON_VERSION_1.getMediaType())
  ...
  public void failsWhenReferredToResourceTypeMissing() throws Exception {
    Referral toCreate =
        MAPPER.readValue(
            fixture("fixtures/legacy/Referral/invalid/referredToResourceType/missing.json"),
            Referral.class);
    Response response =
        resources.client().target(ROOT_RESOURCE).request()
            .accept(Api.Version.JSON_VERSION_1.getMediaType())
  ...
  public void failsWhenReferredToResourceTypeNull() throws Exception {
    Referral toCreate =
        MAPPER.readValue(
            fixture("fixtures/legacy/Referral/invalid/referredToResourceType/null.json"),
            Referral.class);
    Response response =
        resources.client().target(ROOT_RESOURCE).request()
            .accept(Api.Version.JSON_VERSION_1.getMediaType())
  ...
  public void failsWhenResponseDeterminationDateWrongFormat() throws Exception {
    Referral toCreate =
        MAPPER.readValue(
            fixture("fixtures/legacy/Referral/invalid/responseDeterminationDate/wrongFormat.json"),
            Referral.class);
    Response response =
        resources.client().target(ROOT_RESOURCE).request()
            .accept(Api.Version.JSON_VERSION_1.getMediaType())
    ...
    assertThat(
        response.readEntity(String.class).indexOf(
            "responseDeterminationDate must be in the format of yyyy-MM-dd"),
        is(greaterThanOrEqualTo(0)));
  }
  ...
  public void failsWhenResponseDeterminationTimeWrongFormat() throws Exception {
    Referral toCreate =
        MAPPER.readValue(
            fixture("fixtures/legacy/Referral/invalid/responseDeterminationTime/wrongFormat.json"),
            Referral.class);
    Response response =
        resources.client().target(ROOT_RESOURCE).request()
            .accept(Api.Version.JSON_VERSION_1.getMediaType())
  ...
  public void failsWhenResponseRationaleTextTooLong() throws Exception {
    Referral toCreate =
        MAPPER.readValue(
            fixture("fixtures/legacy/Referral/invalid/responseRationaleText/tooLong.json"),
            Referral.class);
    Response response =
        resources.client().target(ROOT_RESOURCE).request()
            .accept(Api.Version.JSON_VERSION_1.getMediaType())
  ...
  public void failsWhenScreenerNoteTextTooLong() throws Exception {
    Referral toCreate =
        MAPPER.readValue(fixture("fixtures/legacy/Referral/invalid/screenerNoteText/tooLong.json"),
            Referral.class);
    Response response =
        resources.client().target(ROOT_RESOURCE).request()
            .accept(Api.Version.JSON_VERSION_1.getMediaType())
  ...
  public void failsWhenSpecificsIncludedCodeMissing() throws Exception {
    Referral toCreate =
        MAPPER.readValue(
            fixture("fixtures/legacy/Referral/invalid/specificsIncludedCode/missing.json"),
            Referral.class);
    Response response =
        resources.client().target(ROOT_RESOURCE).request()
            .accept(Api.Version.JSON_VERSION_1.getMediaType())
  ...
  public void failsWhenSpecificsIncludedCodeNull() throws Exception {
    Referral toCreate =
        MAPPER.readValue(
            fixture("fixtures/legacy/Referral/invalid/specificsIncludedCode/null.json"),
            Referral.class);
    Response response =
        resources.client().target(ROOT_RESOURCE).request()
            .accept(Api.Version.JSON_VERSION_1.getMediaType())
  ...
  public void failsWhenSpecificsIncludedCodeEmpty() throws Exception {
    Referral toCreate =
        MAPPER.readValue(
            fixture("fixtures/legacy/Referral/invalid/specificsIncludedCode/empty.json"),
            Referral.class);
    Response response =
        resources.client().target(ROOT_RESOURCE).request()
            .accept(Api.Version.JSON_VERSION_1.getMediaType())
  ...
  public void failsWhenSpecificsIncludedCodeTooLong() throws Exception {
    Referral toCreate =
        MAPPER.readValue(
            fixture("fixtures/legacy/Referral/invalid/specificsIncludedCode/tooLong.json"),
            Referral.class);
    Response response =
        resources.client().target(ROOT_RESOURCE).request()
            .accept(Api.Version.JSON_VERSION_1.getMediaType())
  ...
  public void failsWhenSufficientInformationCodeMissing() throws Exception {
    Referral toCreate =
        MAPPER.readValue(
            fixture("fixtures/legacy/Referral/invalid/sufficientInformationCode/missing.json"),
            Referral.class);
    Response response =
        resources.client().target(ROOT_RESOURCE).request()
            .accept(Api.Version.JSON_VERSION_1.getMediaType())
  ...
  public void failsWhenSufficientInformationCodeNull() throws Exception {
    Referral toCreate =
        MAPPER.readValue(
            fixture("fixtures/legacy/Referral/invalid/sufficientInformationCode/null.json"),
            Referral.class);
    Response response =
        resources.client().target(ROOT_RESOURCE).request()
            .accept(Api.Version.JSON_VERSION_1.getMediaType())
  ...
  public void failsWhenSufficientInformationCodeEmpty() throws Exception {
    Referral toCreate =
        MAPPER.readValue(
            fixture("fixtures/legacy/Referral/invalid/sufficientInformationCode/empty.json"),
            Referral.class);
    Response response =
        resources.client().target(ROOT_RESOURCE).request()
            .accept(Api.Version.JSON_VERSION_1.getMediaType())
  ...
  public void failsWhenSufficientInformationCodeTooLong() throws Exception {
    Referral toCreate =
        MAPPER.readValue(
            fixture("fixtures/legacy/Referral/invalid/sufficientInformationCode/tooLong.json"),
            Referral.class);
    Response response =
        resources.client().target(ROOT_RESOURCE).request()
            .accept(Api.Version.JSON_VERSION_1.getMediaType())
    ...
    assertThat(response.getStatus(), is(equalTo(422)));
    assertThat(response.readEntity(String.class)
        .indexOf("sufficientInformationCode size must be 1"), is(greaterThanOrEqualTo(0)));
  }
  ...
  public void failsWhenUnfoundedSeriesCodeMissing() throws Exception {
    Referral toCreate =
        MAPPER.readValue(
            fixture("fixtures/legacy/Referral/invalid/unfoundedSeriesCode/missing.json"),
            Referral.class);
    Response response =
        resources.client().target(ROOT_RESOURCE).request()
            .accept(Api.Version.JSON_VERSION_1.getMediaType())
  ...
  public void failsWhenUnfoundedSeriesCodeNull() throws Exception {
    Referral toCreate =
        MAPPER.readValue(fixture("fixtures/legacy/Referral/invalid/unfoundedSeriesCode/null.json"),
            Referral.class);
    Response response =
        resources.client().target(ROOT_RESOURCE).request()
            .accept(Api.Version.JSON_VERSION_1.getMediaType())
  ...
  public void failsWhenUnfoundedSeriesCodeEmpty() throws Exception {
    Referral toCreate =
        MAPPER.readValue(
            fixture("fixtures/legacy/Referral/invalid/unfoundedSeriesCode/empty.json"),
            Referral.class);
    Response response =
        resources.client().target(ROOT_RESOURCE).request()
            .accept(Api.Version.JSON_VERSION_1.getMediaType())
  ...
  public void failsWhenUnfoundedSeriesCodeTooLong() throws Exception {
    Referral toCreate =
        MAPPER.readValue(
            fixture("fixtures/legacy/Referral/invalid/unfoundedSeriesCode/tooLong.json"),
            Referral.class);
    Response response =
        resources.client().target(ROOT_RESOURCE).request()
            .accept(Api.Version.JSON_VERSION_1.getMediaType())
  ...
  public void failsWhenLinkToPrimaryReferralIdTooLong() throws Exception {
    Referral toCreate =
        MAPPER.readValue(
            fixture("fixtures/legacy/Referral/invalid/linkToPrimaryReferralId/tooLong.json"),
            Referral.class);
    Response response =
        resources.client().target(ROOT_RESOURCE).request()
            .accept(Api.Version.JSON_VERSION_1.getMediaType())
  ...
  public void failsWhenAllegesAbuseOccurredAtAddressIdTooLong() throws Exception {
    ...
    assertThat(
        response.readEntity(String.class).indexOf(
            "allegesAbuseOccurredAtAddressId size must be between 0 and 10"),
        is(greaterThanOrEqualTo(0)));
  }
  ...
  public void failsWhenFirstResponseDeterminedByStaffPersonIdTooLong() throws Exception {
    ...
    assertThat(
        response.readEntity(String.class).indexOf(
            "firstResponseDeterminedByStaffPersonId size must be between 0 and 3"),
        is(greaterThanOrEqualTo(0)));
  }
  ...
  public void failsWhenPrimaryContactStaffPersonIdMissing() throws Exception {
    Referral toCreate =
        MAPPER.readValue(
            fixture("fixtures/legacy/Referral/invalid/primaryContactStaffPersonId/missing.json"),
            Referral.class);
    Response response =
        resources.client().target(ROOT_RESOURCE).request()
            .accept(Api.Version.JSON_VERSION_1.getMediaType())
  ...
  public void failsWhenPrimaryContactStaffPersonIdNull() throws Exception {
    Referral toCreate =
        MAPPER.readValue(
            fixture("fixtures/legacy/Referral/invalid/primaryContactStaffPersonId/null.json"),
            Referral.class);
    Response response =
        resources.client().target(ROOT_RESOURCE).request()
            .accept(Api.Version.JSON_VERSION_1.getMediaType())
  ...
  public void failsWhenPrimaryContactStaffPersonIdEmpty() throws Exception {
    Referral toCreate =
        MAPPER.readValue(
            fixture("fixtures/legacy/Referral/invalid/primaryContactStaffPersonId/empty.json"),
            Referral.class);
    Response response =
        resources.client().target(ROOT_RESOURCE).request()
            .accept(Api.Version.JSON_VERSION_1.getMediaType())
  ...
  public void failsWhenPrimaryContactStaffPersonIdTooLong() throws Exception {
    Referral toCreate =
        MAPPER.readValue(
            fixture("fixtures/legacy/Referral/invalid/primaryContactStaffPersonId/tooLong.json"),
            Referral.class);
    Response response =
        resources.client().target(ROOT_RESOURCE).request()
            .accept(Api.Version.JSON_VERSION_1.getMediaType())
    ...
    assertThat(
        response.readEntity(String.class).indexOf(
            "primaryContactStaffPersonId size must be between 1 and 3"),
        is(greaterThanOrEqualTo(0)));
  }
  ...
  public void failsWhenCountySpecificCodeMissing() throws Exception {
    Referral toCreate =
        MAPPER.readValue(
            fixture("fixtures/legacy/Referral/invalid/countySpecificCode/missing.json"),
            Referral.class);
    Response response =
        resources.client().target(ROOT_RESOURCE).request()
            .accept(Api.Version.JSON_VERSION_1.getMediaType())
  ...
  public void failsWhenCountySpecificCodeNull() throws Exception {
    Referral toCreate =
        MAPPER.readValue(fixture("fixtures/legacy/Referral/invalid/countySpecificCode/null.json"),
            Referral.class);
    Response response =
        resources.client().target(ROOT_RESOURCE).request()
            .accept(Api.Version.JSON_VERSION_1.getMediaType())
  ...
  public void failsWhenCountySpecificCodeEmpty() throws Exception {
    Referral toCreate =
        MAPPER.readValue(fixture("fixtures/legacy/Referral/invalid/countySpecificCode/empty.json"),
            Referral.class);
    Response response =
        resources.client().target(ROOT_RESOURCE).request()
            .accept(Api.Version.JSON_VERSION_1.getMediaType())
  ...
  public void failsWhenCountySpecificCodeTooLong() throws Exception {
    Referral toCreate =
        MAPPER.readValue(
            fixture("fixtures/legacy/Referral/invalid/countySpecificCode/tooLong.json"),
            Referral.class);
    Response response =
        resources.client().target(ROOT_RESOURCE).request()
            .accept(Api.Version.JSON_VERSION_1.getMediaType())
  ...
  public void failsWhenSpecialProjectReferralIndicatorMissing() throws Exception {
    ...
    assertThat(
        response.readEntity(String.class)
            .indexOf("specialProjectReferralIndicator may not be null"),
        is(greaterThanOrEqualTo(0)));
  }
  ...
  public void failsWhenSpecialProjectReferralIndicatorNull() throws Exception {
    Referral toCreate =
        MAPPER.readValue(
            fixture("fixtures/legacy/Referral/invalid/specialProjectReferralIndicator/null.json"),
            Referral.class);
    Response response =
        resources.client().target(ROOT_RESOURCE).request()
            .accept(Api.Version.JSON_VERSION_1.getMediaType())
  ...
  public void failsWhenSpecialProjectReferralIndicatorEmpty() throws Exception {
    Referral toCreate =
        MAPPER.readValue(
            fixture("fixtures/legacy/Referral/invalid/specialProjectReferralIndicator/empty.json"),
            Referral.class);
    Response response =
        resources.client().target(ROOT_RESOURCE).request()
            .accept(Api.Version.JSON_VERSION_1.getMediaType())
  ...
  public void failsWhenZippyCreatedIndicatorMissing() throws Exception {
    Referral toCreate =
        MAPPER.readValue(
            fixture("fixtures/legacy/Referral/invalid/zippyCreatedIndicator/missing.json"),
            Referral.class);
    Response response =
        resources.client().target(ROOT_RESOURCE).request()
            .accept(Api.Version.JSON_VERSION_1.getMediaType())
  ...
  public void failsWhenZippyCreatedIndicatorNull() throws Exception {
    Referral toCreate =
        MAPPER.readValue(
            fixture("fixtures/legacy/Referral/invalid/zippyCreatedIndicator/null.json"),
            Referral.class);
    Response response =
        resources.client().target(ROOT_RESOURCE).request()
            .accept(Api.Version.JSON_VERSION_1.getMediaType())
  ...
  public void failsWhenZippyCreatedIndicatorEmpty() throws Exception {
    Referral toCreate =
        MAPPER.readValue(
            fixture("fixtures/legacy/Referral/invalid/zippyCreatedIndicator/empty.json"),
            Referral.class);
    Response response =
        resources.client().target(ROOT_RESOURCE).request()
            .accept(Api.Version.JSON_VERSION_1.getMediaType())
  ...
  public void failsWhenZippyCreatedIndicatorAllWhitespace() throws Exception {
    Referral toCreate =
        MAPPER.readValue(
            fixture("fixtures/legacy/Referral/invalid/zippyCreatedIndicator/allWhitespace.json"),
            Referral.class);
    Response response =
        resources.client().target(ROOT_RESOURCE).request()
            .accept(Api.Version.JSON_VERSION_1.getMediaType())
  ...
  public void failsWhenHomelessIndicatorMissing() throws Exception {
    Referral toCreate =
        MAPPER.readValue(
            fixture("fixtures/legacy/Referral/invalid/homelessIndicator/missing.json"),
            Referral.class);
    Response response =
        resources.client().target(ROOT_RESOURCE).request()
            .accept(Api.Version.JSON_VERSION_1.getMediaType())
  ...
  public void failsWhenHomelessIndicatorNull() throws Exception {
    Referral toCreate =
        MAPPER.readValue(fixture("fixtures/legacy/Referral/invalid/homelessIndicator/null.json"),
            Referral.class);
    Response response =
        resources.client().target(ROOT_RESOURCE).request()
            .accept(Api.Version.JSON_VERSION_1.getMediaType())
  ...
  public void failsWhenHomelessIndicatorEmpty() throws Exception {
    Referral toCreate =
        MAPPER.readValue(fixture("fixtures/legacy/Referral/invalid/homelessIndicator/empty.json"),
            Referral.class);
    Response response =
        resources.client().target(ROOT_RESOURCE).request()
            .accept(Api.Version.JSON_VERSION_1.getMediaType())
  ...
  public void failsWhenHomelessIndicatorAllWhitespace() throws Exception {
    Referral toCreate =
        MAPPER.readValue(
            fixture("fixtures/legacy/Referral/invalid/homelessIndicator/allWhitespace.json"),
            Referral.class);
    Response response =
        resources.client().target(ROOT_RESOURCE).request()
            .accept(Api.Version.JSON_VERSION_1.getMediaType())
  ...
  public void failsWhenFamilyRefusedServicesIndicatorNull() throws Exception {
    Referral toCreate =
        MAPPER.readValue(
            fixture("fixtures/legacy/Referral/invalid/familyRefusedServicesIndicator/null.json"),
            Referral.class);
    Response response =
        resources.client().target(ROOT_RESOURCE).request()
            .accept(Api.Version.JSON_VERSION_1.getMediaType())
  ...
  public void failsWhenFamilyRefusedServicesIndicatorEmpty() throws Exception {
    Referral toCreate =
        MAPPER.readValue(
            fixture("fixtures/legacy/Referral/invalid/familyRefusedServicesIndicator/empty.json"),
            Referral.class);
    Response response =
        resources.client().target(ROOT_RESOURCE).request()
            .accept(Api.Version.JSON_VERSION_1.getMediaType())
  ...
  public void failsWhenFirstEvaluatedOutApprovalDateWrongFormat() throws Exception {
    ...
    assertThat(
        response.readEntity(String.class).indexOf(
            "firstEvaluatedOutApprovalDate must be in the format of yyyy-MM-dd"),
        is(greaterThanOrEqualTo(0)));
  }
  ...
  public void failsWhenResponsibleAgencyCodeMissing() throws Exception {
    Referral toCreate =
        MAPPER.readValue(
            fixture("fixtures/legacy/Referral/invalid/responsibleAgencyCode/missing.json"),
            Referral.class);
    Response response =
        resources.client().target(ROOT_RESOURCE).request()
            .accept(Api.Version.JSON_VERSION_1.getMediaType())
  ...
  public void failsWhenResponsibleAgencyCodeNull() throws Exception {
    Referral toCreate =
        MAPPER.readValue(
            fixture("fixtures/legacy/Referral/invalid/responsibleAgencyCode/null.json"),
            Referral.class);
    Response response =
        resources.client().target(ROOT_RESOURCE).request()
            .accept(Api.Version.JSON_VERSION_1.getMediaType())
  ...
  public void failsWhenResponsibleAgencyCodeEmpty() throws Exception {
    Referral toCreate =
        MAPPER.readValue(
            fixture("fixtures/legacy/Referral/invalid/responsibleAgencyCode/empty.json"),
            Referral.class);
    Response response =
        resources.client().target(ROOT_RESOURCE).request()
            .accept(Api.Version.JSON_VERSION_1.getMediaType())
  ...
  public void failsWhenResponsibleAgencyCodeTooLong() throws Exception {
    Referral toCreate =
        MAPPER.readValue(
            fixture("fixtures/legacy/Referral/invalid/responsibleAgencyCode/tooLong.json"),
            Referral.class);
    Response response =
        resources.client().target(ROOT_RESOURCE).request()
            .accept(Api.Version.JSON_VERSION_1.getMediaType())
  ...
  public void failsWhenResponsibleAgencyCodeNotValidValue() throws Exception {
    Referral toCreate =
        MAPPER.readValue(
            fixture("fixtures/legacy/Referral/invalid/responsibleAgencyCode/notValidValue.json"),
            Referral.class);
    Response response =
        resources.client().target(ROOT_RESOURCE).request()
            .accept(Api.Version.JSON_VERSION_1.getMediaType())
    ...
    assertThat(
        response.readEntity(String.class).indexOf(
            "responsibleAgencyCode must be one of [C, P, O, A, S, I, K, M]"),
        is(greaterThanOrEqualTo(0)));
  }
  ...
  public void failsWhenLimitedAccessDateWrongFormat() throws Exception {
    Referral toCreate =
        MAPPER.readValue(
            fixture("fixtures/legacy/Referral/invalid/limitedAccessDate/wrongFormat.json"),
            Referral.class);
    Response response =
        resources.client().target(ROOT_RESOURCE).request()
            .accept(Api.Version.JSON_VERSION_1.getMediaType())
  ...
  public void failsWhenOriginalClosureDateWrongFormat() throws Exception {
    Referral toCreate =
        MAPPER.readValue(
            fixture("fixtures/legacy/Referral/invalid/originalClosureDate/wrongFormat.json"),
            Referral.class);
    Response response =
        resources.client().target(ROOT_RESOURCE).request()
            .accept(Api.Version.JSON_VERSION_1.getMediaType())
    ...
    assertThat(
        response.readEntity(String.class).indexOf(
            "originalClosureDate must be in the format of yyyy-MM-dd"), is(greaterThanOrEqualTo(0)));
  }
