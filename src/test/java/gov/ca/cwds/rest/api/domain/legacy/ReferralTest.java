...
public class ReferralTest {
	...
	@ClassRule
	public static final ResourceTestRule resources = ResourceTestRule.builder().addResource(mockedReferralResource)
			.build();
	...
	public void persistentObjectConstructorTest() throws Exception {
		Referral domain = new Referral(id, additionalInfoIncludedCode, anonymousReporterIndicator,
				...
				limitedAccessCode, mandatedCrossReportReceivedDate, referralName, openAdequateCaseCode, receivedDate,
		...
		gov.ca.cwds.rest.api.persistence.legacy.Referral persistent = new gov.ca.cwds.rest.api.persistence.legacy.Referral(
		...
		assertThat(totest.getApplicationForPetitionIndicator(),
		...
		assertThat(totest.getFiledSuspectedChildAbuseReporttoLawEnforcementIndicator(), is(equalTo(DomainObject
				.uncookBooleanString(persistent.getFiledSuspectedChildAbuseReporttoLawEnforcementIndicator()))));
		...
		assertThat(totest.getSpecialProjectReferralIndicator(),
		...
		assertThat(totest.getFamilyRefusedServicesIndicator(),
	...
	public void deserializesFromJSON() throws Exception {
		assertThat(MAPPER.readValue(fixture("fixtures/legacy/Referral/valid/valid.json"), Referral.class),
	...
	public void failsWhenMandatedCrossReportReceivedDateWrongFormat() throws Exception {
		...
		assertThat(
				response.readEntity(String.class)
						.indexOf("mandatedCrossReportReceivedDate must be in the format of yyyy-MM-dd"),
				is(greaterThanOrEqualTo(0)));
	}
	...
	private Referral validReferral() {
		return new Referral("DEF", "A", false, false, "A3CDEOm0Ab", new Short((short) 122), "A", "2000-03-03",
				new Short((short) 409), "current", "abcdefg", "A3B7sSC0Ab", "efghijk", false, false,
				new Short((short) 1118), "A", false, "N", "2000-01-31", "Verification (R3)                  ", "A",
				"2000-01-01", "16:41:49", new Short((short) 1520), new Short((short) 0), "2000-01-31", "16:41:49",
				"lmnopq", "rstuvw", "A", "A", "A", "sdfghj", "kjhgfdl", "0Ab", "q1p", "51", false, false, false, false,
				"2000-05-05", "C", new Short((short) 1234), "2000-05-05", "thjkl", "2000-05-05");
	}
}
