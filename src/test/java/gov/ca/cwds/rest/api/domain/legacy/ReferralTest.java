...
public class ReferralTest {
  ...
  public void persistentObjectConstructorTest() throws Exception {
    ...
    gov.ca.cwds.rest.api.persistence.cms.Referral persistent =
    ...
    assertThat(totest.getApplicationForPetitionIndicator(), is(equalTo(
        DomainObject.uncookBooleanString(persistent.getApplicationForPetitionIndicator()))));
    ...
    assertThat(totest.getCaretakersPerpetratorCode(),
        is(equalTo(DomainObject.uncookBooleanString(persistent.getCaretakersPerpetratorCode()))));
    ...
    assertThat(totest.getFiledSuspectedChildAbuseReporttoLawEnforcementIndicator(),
        is(equalTo(DomainObject.uncookBooleanString(
    ...
    assertThat(totest.getSpecialProjectReferralIndicator(), is(equalTo(
        DomainObject.uncookBooleanString(persistent.getSpecialProjectReferralIndicator()))));
    ...
    assertThat(totest.getFamilyRefusedServicesIndicator(), is(
        equalTo(DomainObject.uncookBooleanString(persistent.getFamilyRefusedServicesIndicator()))));
