...
public class ScreeningRequestTest {
  ...
  public void serializesToJSON() throws Exception {
    Address address = new Address("10 main st", "Sacramento", "CA", 95814, null);
  ...
  public void deserializesFromJSON() throws Exception {
    ...
    ScreeningRequest expected =
        new ScreeningRequest("X5HNJK", "11/22/1973", "Amador", "11/22/1973", "Home", "email",
            "First screening", "immediate", "accept_for_investigation", "10/11/2016",
            "first narrative", address);
    ScreeningRequest serialized =
        MAPPER.readValue(fixture("fixtures/domain/screeningRequest/valid/valid.json"),
