...
public class ReportResourceImplTest {
	...
	@Before
	public void setup() {
		when(serviceEnvironment.getService(ReporterService.class, ApiPoc.Version.JSON_VERSION_1.getMediaType())).thenReturn(reporterService);
	}
	...
	public void getDelegatestoCrudsResource() throws Exception {
		...
		verify(crudsResource, times(1)).get(toVerify.getReferralId(), ApiPoc.MEDIA_TYPE_JSON_V1);
	}
