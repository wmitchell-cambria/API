...
public class ScreeningResourceTest {
  ...
  public static final ResourceTestRule inMemoryResource =
      ResourceTestRule.builder().addResource(new ScreeningResource()).build();
  ...
  public static final ResourceTestRule grizzlyResource =
      ResourceTestRule.builder().setTestContainerFactory(new GrizzlyWebTestContainerFactory())
          .addResource(new ScreeningResource()).build();
  ...
  public void getReturnsJsonWhichCanBeSerializedIntoScreening() throws Exception {
    String json = inMemoryResource.client().target(FOUND_RESOURCE).request()
        .accept(MediaType.APPLICATION_JSON).get().readEntity(String.class);
    Screening getresult = MAPPER.readValue(json, Screening.class);
    Screening expected = new Screening((long) 101, "reference", "12/22/2001", "county",
        "11/22/2010", "home", "method", "name", "time", "decision", "11/22/2010", "narrative");
  ...
  public void createReturns201OnSuccess() throws Exception {
    Screening screening = new Screening((long) 101, "reference", "12/22/2001", "county",
        "11/22/2010", "home", "method", "name", "time", "decision", "11/22/2010", "narrative");
  ...
  public void createReturns406OnWrongAcceptType() throws Exception {
    Screening screening = new Screening((long) 101, "reference", "12/22/2001", "county",
        "11/22/2010", "home", "method", "name", "time", "decision", "11/22/2010", "narrative");
    int status =
        grizzlyResource.getJerseyTest().target(ROOT_RESOURCE).request().accept("UNSUPPORTED_TYPE")
            .post(Entity.entity(screening, MediaType.APPLICATION_JSON)).getStatus();
  ...
  public void createReturns422WhenCannotValidateScreening() throws Exception {
    Screening screening = new Screening((long) 101, "reference", "12/22/2001", "county",
        "22/11/2010", "home", "method", "name", "time", "decision", "11/22/2010", "narrative");
    int status = grizzlyResource.getJerseyTest().target(ROOT_RESOURCE).request()
        .accept(MediaType.APPLICATION_JSON)
        .post(Entity.entity(screening, MediaType.APPLICATION_JSON)).getStatus();
  ...
  public void createReturnsLocationHeader() throws Exception {
    Screening screening = new Screening((long) 101, "reference", "12/22/2001", "county",
        "11/22/2010", "home", "method", "name", "time", "decision", "11/22/2010", "narrative");
    Object o = grizzlyResource.getJerseyTest().target(ROOT_RESOURCE).request()
        .accept(MediaType.APPLICATION_JSON)
  ...
  public void createReturnsProperJson() throws Exception {
    String expected =
        "{ \"id\": \"1\", \"Screening\": { \"id\": 101, \"reference\": \"reference\", \"ended_at\": \"12/22/2001\", "
    ...
    Screening screening = new Screening((long) 101, "reference", "12/22/2001", "county",
        "11/22/2010", "home", "method", "name", "time", "decision", "11/22/2010", "narrative");
    String json = grizzlyResource.getJerseyTest().target(ROOT_RESOURCE).request()
        .accept(MediaType.APPLICATION_JSON)
