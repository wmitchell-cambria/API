...
public class ApiResponseSerializerTest {
	...
	public void testSerialization() throws Exception{
		String expected = "{\"id\":\"1\",\"Address\":{\"street_address\":\"street\",\"city\":\"city\",\"state\":\"state\",\"zip\":95672}}";
		ApiResponse<Address> addressApiResponse = new ApiResponse<Address>("1", new Address("street", "city", "state", 95672));
