...
private ReferralService referralService;
    ...
    public MockedScreeningToReferralServiceBuilder addAddressService(
    ...
    public MockedScreeningToReferralServiceBuilder addMessageBuilder(
    ...
    public ScreeningToReferralService createScreeningToReferralService() {
      return new ScreeningToReferralService(getReferralService(), getClientService(),
          ...
          getReporterService(),
          getAddressService(), getClientAddressService(), getLongTextService(),
          getChildClientService(),
          Validation.buildDefaultValidatorFactory().getValidator(), getReferralDao(),
          getStaffPersonIdRetriever(), getMessageBuilder());
    }
}
