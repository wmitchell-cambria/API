...
/**
 * Proudly plagiarized from <a href="https://github.com/sfragis/GuiceJUnitRunner">Fabio Strozzi's
 * GitHub</a>.
 * 
 * <p>
...
public class GuiceJUnitRunner extends BlockJUnit4ClassRunner {
   ...
   * 
   * @param klass The test class
   * @return The array of Guice {@link Module} modules used to initialize the injector for the given
   *         test.
   * @throws InitializationError
   */
