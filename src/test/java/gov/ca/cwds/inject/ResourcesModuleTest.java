...
import gov.ca.cwds.rest.services.investigation.*;
...
public class ResourcesModuleTest {
    ...
    public void screeningSummaryServiceBackedResourceShouldRetrieveServiceFromInjector(){
        ...
        verify(injector).getInstance(gov.ca.cwds.rest.services.investigation.ScreeningSummaryService.class);
    }
    ...
    @Test
    public void intakeIndexQueryServiceBackedResourceShouldRetrieveServiceFromInjector(){
        resourceModule.intakeIndexQueryResource(injector);
        verify(injector).getInstance(IndexQueryService.class);
    }
