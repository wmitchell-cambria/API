...
public class Reporter extends PersistentObject {
	...
	public int hashCode() {
		...
		result = prime * result + ((confidentialWaiverIndicator == null) ? 0 : confidentialWaiverIndicator.hashCode());
		result = prime * result + ((countySpecificCode == null) ? 0 : countySpecificCode.hashCode());
		result = prime * result + ((drmsMandatedRprtrFeedback == null) ? 0 : drmsMandatedRprtrFeedback.hashCode());
		...
		result = prime * result + ((feedbackRequiredIndicator == null) ? 0 : feedbackRequiredIndicator.hashCode());
		result = prime * result + ((firstName == null) ? 0 : firstName.hashCode());
		result = prime * result + ((lastName == null) ? 0 : lastName.hashCode());
		result = prime * result + ((lawEnforcementId == null) ? 0 : lawEnforcementId.hashCode());
		result = prime * result + ((mandatedReporterIndicator == null) ? 0 : mandatedReporterIndicator.hashCode());
		result = prime * result + ((messagePhoneExtensionNumber == null) ? 0 : messagePhoneExtensionNumber.hashCode());
		...
		result = prime * result + ((namePrefixDescription == null) ? 0 : namePrefixDescription.hashCode());
		result = prime * result + ((primaryPhoneExtensionNumber == null) ? 0 : primaryPhoneExtensionNumber.hashCode());
		...
		result = prime * result + ((suffixTitleDescription == null) ? 0 : suffixTitleDescription.hashCode());
