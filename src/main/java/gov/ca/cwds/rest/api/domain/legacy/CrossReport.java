...
public class CrossReport extends DomainObject {
	...
	public CrossReport(gov.ca.cwds.rest.api.persistence.legacy.CrossReport persistedCrossReport) {
        ...
        this.governmentOrgCrossRptIndicatorVar = DomainObject.uncookBooleanString(persistedCrossReport.getGovernmentOrgCrossRptIndicatorVar());
	...
	public int hashCode() {
		...
		result = prime
				* result
				+ ((crossReportMethodType == null) ? 0 : crossReportMethodType
						.hashCode());
		result = prime * result
				+ ((description == null) ? 0 : description.hashCode());
		result = prime
				* result
				+ ((filedOutOfStateIndicator == null) ? 0
						: filedOutOfStateIndicator.hashCode());
		result = prime
				* result
		...
		result = prime
				* result
				+ ((lawEnforcementId == null) ? 0 : lawEnforcementId.hashCode());
		result = prime
				* result
				+ ((lawEnforcementIndicator == null) ? 0
						: lawEnforcementIndicator.hashCode());
		result = prime
				* result
				+ ((outStateLawEnforcementIndicator == null) ? 0
						: outStateLawEnforcementIndicator.hashCode());
		result = prime
				* result
				+ ((outstateLawEnforcementAddr == null) ? 0
						: outstateLawEnforcementAddr.hashCode());
		result = prime
				* result
				+ ((recipientBadgeNumber == null) ? 0 : recipientBadgeNumber
						.hashCode());
		result = prime * result
		...
		result = prime
				* result
				+ ((recipientPositionTitleDesc == null) ? 0
						: recipientPositionTitleDesc.hashCode());
		result = prime * result
		...
		result = prime
				* result
				+ ((satisfyCrossReportIndicator == null) ? 0
						: satisfyCrossReportIndicator.hashCode());
		result = prime * result
				+ ((staffPersonId == null) ? 0 : staffPersonId.hashCode());
	...
	public boolean equals(Object obj) {
		...
		if (filedOutOfStateIndicator == null) {
			if (other.filedOutOfStateIndicator != null)
				return false;
		} else if (!filedOutOfStateIndicator
				.equals(other.filedOutOfStateIndicator))
			return false;
		...
		if (lawEnforcementIndicator == null) {
			if (other.lawEnforcementIndicator != null)
				return false;
		} else if (!lawEnforcementIndicator
				.equals(other.lawEnforcementIndicator))
			return false;
		if (outStateLawEnforcementIndicator == null) {
			if (other.outStateLawEnforcementIndicator != null)
				return false;
		} else if (!outStateLawEnforcementIndicator
				.equals(other.outStateLawEnforcementIndicator))
			return false;
		if (outstateLawEnforcementAddr == null) {
			if (other.outstateLawEnforcementAddr != null)
				return false;
		} else if (!outstateLawEnforcementAddr
				.equals(other.outstateLawEnforcementAddr))
			return false;
		...
		if (recipientPositionTitleDesc == null) {
			if (other.recipientPositionTitleDesc != null)
				return false;
		} else if (!recipientPositionTitleDesc
				.equals(other.recipientPositionTitleDesc))
			return false;
		...
		if (satisfyCrossReportIndicator == null) {
			if (other.satisfyCrossReportIndicator != null)
				return false;
		} else if (!satisfyCrossReportIndicator
				.equals(other.satisfyCrossReportIndicator))
			return false;
