 ...
 */
@NamedQueries({
    @NamedQuery(name = "gov.ca.cwds.rest.api.persistence.cms.SubstituteCareProvider.findAll",
        query = "FROM SubstituteCareProvider"),
    @NamedQuery(
        name = "gov.ca.cwds.rest.api.persistence.cms.SubstituteCareProvider.findAllUpdatedAfter",
