...
public class Allegation extends DomainObject {
	...
	@ApiModelProperty(required=true, readOnly=false, value="", example="D", allowableValues = "D, M, W, Y")
	...
	@ApiModelProperty(required=true, readOnly=false, value="", example="U", allowableValues = "U, P, Y, N")
	...
	public Allegation(gov.ca.cwds.rest.api.persistence.legacy.Allegation persistedAllegation) {
		...
		this.zippyCreatedIndicator = DomainObject.uncookBooleanString(persistedAllegation.getZippyCreatedIndicator());
	...
	public int hashCode() {
		...
		int result = 1;
		result = prime * result
				+ ((abuseEndDate == null) ? 0 : abuseEndDate.hashCode());
		result = prime * result
				+ ((abuseFrequency == null) ? 0 : abuseFrequency.hashCode());
		result = prime
				* result
				+ ((abuseFrequencyPeriodCode == null)
						? 0
						: abuseFrequencyPeriodCode.hashCode());
		result = prime
				* result
				+ ((abuseLocationDescription == null)
						? 0
						: abuseLocationDescription.hashCode());
		result = prime * result
				+ ((abuseStartDate == null) ? 0 : abuseStartDate.hashCode());
		result = prime
				* result
				+ ((allegationDispositionType == null)
						? 0
						: allegationDispositionType.hashCode());
		result = prime * result
				+ ((allegationType == null) ? 0 : allegationType.hashCode());
		result = prime
				* result
		...
		result = prime
				* result
				+ ((dispositionDescription == null)
						? 0
						: dispositionDescription.hashCode());
		result = prime * result
				+ ((fkClient0 == null) ? 0 : fkClient0.hashCode());
		result = prime * result
				+ ((fkClientT == null) ? 0 : fkClientT.hashCode());
		result = prime * result
				+ ((fkReferralT == null) ? 0 : fkReferralT.hashCode());
		result = prime * result + ((id == null) ? 0 : id.hashCode());
		result = prime
				* result
				+ ((injuryHarmDetailIndicator == null)
						? 0
						: injuryHarmDetailIndicator.hashCode());
		result = prime
				* result
				+ ((nonProtectingParentCode == null)
						? 0
						: nonProtectingParentCode.hashCode());
		result = prime
				* result
				+ ((placementFacilityType == null) ? 0 : placementFacilityType
						.hashCode());
		result = prime
				* result
				+ ((staffPersonAddedIndicator == null)
						? 0
						: staffPersonAddedIndicator.hashCode());
		result = prime
				* result
	...
	public boolean equals(Object obj) {
		...
		} else if (!abuseFrequencyPeriodCode
				.equals(other.abuseFrequencyPeriodCode)) {
			return false;
		}
		...
		} else if (!abuseLocationDescription
				.equals(other.abuseLocationDescription)) {
			return false;
		}
		...
		} else if (!allegationDispositionType
				.equals(other.allegationDispositionType)) {
			return false;
		}
		...
		} else if (!injuryHarmDetailIndicator
				.equals(other.injuryHarmDetailIndicator)) {
			return false;
		}
		...
		} else if (!nonProtectingParentCode
				.equals(other.nonProtectingParentCode)) {
			return false;
		}
		...
		} else if (!staffPersonAddedIndicator
				.equals(other.staffPersonAddedIndicator)) {
			return false;
		}
