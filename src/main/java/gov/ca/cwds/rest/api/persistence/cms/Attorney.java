 ...
 */
@NamedQueries({
    @NamedQuery(name = "gov.ca.cwds.rest.api.persistence.cms.Attorney.findAll",
        query = "FROM Attorney"),
    @NamedQuery(name = "gov.ca.cwds.rest.api.persistence.cms.Attorney.findAllUpdatedAfter",
