...
public class Reporter extends DomainObject {
	...
	public Reporter(gov.ca.cwds.rest.api.persistence.legacy.Reporter persistedReporter) {
        ...
        this.confidentialWaiverIndicator = DomainObject.uncookBooleanString(persistedReporter.getConfidentialWaiverIndicator());
        ...
        this.feedbackRequiredIndicator = DomainObject.uncookBooleanString(persistedReporter.getFeedbackRequiredIndicator());
        this.firstName = persistedReporter.getFirstName();
        this.lastName = persistedReporter.getLastName();
        this.mandatedReporterIndicator = DomainObject.uncookBooleanString(persistedReporter.getMandatedReporterIndicator());
	...
	public int hashCode() {
		...
		int result = 1;
		result = prime * result
				+ ((badgeNumber == null) ? 0 : badgeNumber.hashCode());
		result = prime * result
				+ ((cityName == null) ? 0 : cityName.hashCode());
		result = prime
				* result
				+ ((colltrClientRptrReltnshpType == null) ? 0
						: colltrClientRptrReltnshpType.hashCode());
		result = prime
				* result
		...
		result = prime
				* result
				+ ((confidentialWaiverIndicator == null) ? 0
						: confidentialWaiverIndicator.hashCode());
		result = prime
				* result
		...
		result = prime
				* result
				+ ((drmsMandatedRprtrFeedback == null) ? 0
						: drmsMandatedRprtrFeedback.hashCode());
		result = prime * result
				+ ((employerName == null) ? 0 : employerName.hashCode());
		result = prime * result
				+ ((feedbackDate == null) ? 0 : feedbackDate.hashCode());
		result = prime
				* result
				+ ((feedbackRequiredIndicator == null) ? 0
		...
		result = prime
				* result
				+ ((middleInitialName == null) ? 0 : middleInitialName
						.hashCode());
		result = prime
				* result
		...
		result = prime * result
				+ ((stateCodeType == null) ? 0 : stateCodeType.hashCode());
		result = prime * result
	...
	public boolean equals(Object obj) {
		...
		if (colltrClientRptrReltnshpType == null) {
			if (other.colltrClientRptrReltnshpType != null)
				return false;
		} else if (!colltrClientRptrReltnshpType
				.equals(other.colltrClientRptrReltnshpType))
			return false;
		...
		if (confidentialWaiverIndicator == null) {
			if (other.confidentialWaiverIndicator != null)
				return false;
		} else if (!confidentialWaiverIndicator
				.equals(other.confidentialWaiverIndicator))
			return false;
		...
		if (drmsMandatedRprtrFeedback == null) {
			if (other.drmsMandatedRprtrFeedback != null)
				return false;
		} else if (!drmsMandatedRprtrFeedback
				.equals(other.drmsMandatedRprtrFeedback))
			return false;
		...
		if (feedbackRequiredIndicator == null) {
			if (other.feedbackRequiredIndicator != null)
				return false;
		} else if (!feedbackRequiredIndicator
				.equals(other.feedbackRequiredIndicator))
			return false;
		if (firstName == null) {
