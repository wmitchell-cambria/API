 ...
 */
@Entity
@Table(schema = "CWSINT", name = "REPTR_T")
public class Reporter extends PersistentObject {
	...
	public Reporter(gov.ca.cwds.rest.api.domain.Reporter reporter, String lastUpdatedId) {
        ...
        try {
            ...
            this.confidentialWaiverIndicator = DomainObject.cookBoolean(reporter.getConfidentialWaiverIndicator());
            ...
            this.feedbackRequiredIndicator = DomainObject.cookBoolean(reporter.getFeedbackRequiredIndicator());
            this.firstName = reporter.getFirstName();
            this.lastName = reporter.getLastName();
            this.mandatedReporterIndicator = DomainObject.cookBoolean(reporter.getMandatedReporterIndicator());
