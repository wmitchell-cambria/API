...
public class StaffPerson extends PersistentObject {
	...
	public StaffPerson(String id, Date endDate, String firstName, String jobTitle, String lastName,
			String middleInitial, String namePrefix, BigDecimal phoneNumber, Integer phoneExt, Date startDate,
			String nameSuffix, String telecommuterIndicator, String cwsOffice,
