 ...
 */
@NamedQueries({
    @NamedQuery(name = "gov.ca.cwds.rest.api.persistence.cms.OtherAdultInPlacemtHome.findAll",
        query = "FROM OtherAdultInPlacemtHome"),
    @NamedQuery(
        name = "gov.ca.cwds.rest.api.persistence.cms.OtherAdultInPlacemtHome.findAllUpdatedAfter",
