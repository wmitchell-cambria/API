...
public class EntityChangedComparator {
   ...
   * safe(compatible) for use in equals and hash methods. Both participant and client are differnent
...
=======
  ...
  public boolean compare(Participant participant, Client client) {
    DateTimeFormatter formatter =
        DateTimeFormat.forPattern(deleteAfterSeconds(DomainChef.TIMESTAMP_FORMAT));;
    ...
    DateTimeFormatter formatter2 =
        DateTimeFormat.forPattern(deleteAfterSeconds(DomainChef.TIMESTAMP_STRICT_FORMAT));
