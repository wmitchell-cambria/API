...
public class ReferralClient extends PersistentObject {
	...
	public int hashCode() {
		...
		result = prime * result
				+ ((drugIndicator == null) ? 0 : drugIndicator.hashCode());
		result = prime
				* result
				+ ((mentalHealthIssuesIndicator == null) ? 0
						: mentalHealthIssuesIndicator.hashCode());
		result = prime * result
				+ ((referralId == null) ? 0 : referralId.hashCode());
		result = prime
				* result
				+ ((selfReportedIndicator == null) ? 0 : selfReportedIndicator
						.hashCode());
		result = prime
				* result
				+ ((staffPersonAddedIndicator == null) ? 0
	...
	public boolean equals(Object obj) {
		...
		if (mentalHealthIssuesIndicator == null) {
			if (other.mentalHealthIssuesIndicator != null)
				return false;
		} else if (!mentalHealthIssuesIndicator
				.equals(other.mentalHealthIssuesIndicator))
			return false;
		if (referralId == null) {
