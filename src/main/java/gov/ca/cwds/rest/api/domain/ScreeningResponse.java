 ...
 */
public final class ScreeningResponse extends DomainObject {
  @JsonProperty("id")
  private Long id;
  ...
  @JsonProperty("involved_people")
  private ArrayList<Person> involved_people;
   ...
   * @param involved_people The involved people
   */
  @JsonCreator
  public ScreeningResponse(@JsonProperty("id") Long id,
      @JsonProperty("reference") String reference, @JsonProperty("ended_at") String ended_at,
      ...
      @JsonProperty("involved_people") ArrayList<Person> involved_people) {
    super();
    this.id = id;
  ...
  /**
   * @return the involved_people
   */
  public ArrayList<Person> getInvolved_people() {
  ...
  public int hashCode() {
    ...
    result = prime * result + ((involved_people == null) ? 0 : involved_people.hashCode());
  ...
  public boolean equals(Object obj) {
    ...
    if (involved_people == null) {
      if (other.involved_people != null) {
        return false;
      }
    } else if (!involved_people.equals(other.involved_people)) {
      return false;
    }
