...
public class StaffPerson extends PersistentObject {
   ...
   */
  public StaffPerson(gov.ca.cwds.rest.api.domain.legacy.StaffPerson staffPerson,
  ...
  public boolean equals(Object obj) {
    ...
    } else if (!availabilityAndLocationDescription.trim().equals(
        other.availabilityAndLocationDescription.trim())) {
      return false;
    }
    if (countyCode == null) {
