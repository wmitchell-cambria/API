...
import gov.ca.cwds.inject.InvestigationServiceBackedResource;
...
public class InvestigationsResource {
  ...
  private TypedResourceDelegate<String, Investigation> typedResourceDelegate;
  ...
  public InvestigationsResource(
      @InvestigationServiceBackedResource TypedResourceDelegate<String, Investigation> typedResourceDelegate) {
