...
public class AssignmentResource {
  ...
  private TypedResourceDelegate<String, Assignment> typedResourceDelegate;
  ...
  public AssignmentResource(
      @AssignmentServiceBackedResource TypedResourceDelegate<String, Assignment> typedResourceDelegate) {
  ...
  public Response create(@Valid @ApiParam(hidden = false, required = true) Assignment assignment) {
    return typedResourceDelegate.create(assignment);
  }
  ...
  public Response update(
    ...
    return typedResourceDelegate.update(id, assignment);
  }
