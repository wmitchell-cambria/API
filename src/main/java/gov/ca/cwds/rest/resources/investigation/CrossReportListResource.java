...
import gov.ca.cwds.inject.InvestigationCrossReportListServiceBackedResource;
...
public class CrossReportListResource {

  private TypedResourceDelegate<String, CrossReportList> typedResourceDelegate;
   ...
   */
  @Inject
  public CrossReportListResource(
      @InvestigationCrossReportListServiceBackedResource TypedResourceDelegate<String, CrossReportList> typedResourceDelegate) {
  ...
  @ApiOperation(value = "Find cross reports of investigation", code = HttpStatus.SC_OK,
      response = CrossReportList.class)
