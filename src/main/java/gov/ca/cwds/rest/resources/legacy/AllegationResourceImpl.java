...
public class AllegationResourceImpl extends BaseResource<AllegationService>
	 ...
	 */
	@Override
	@ApiOperation(value = "Create Allegation", response = Object.class, code = HttpStatus.SC_CREATED, responseHeaders = @ResponseHeader(name = "Location", description = "Link to the newly created object", response = Object.class))
