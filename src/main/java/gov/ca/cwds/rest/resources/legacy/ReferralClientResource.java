 ...
 */
@Api(value = RESOURCE_REFERRAL_CLIENT, tags = RESOURCE_REFERRAL_CLIENT, produces=gov.ca.cwds.rest.core.Api.MEDIA_TYPE_JSON_V1, consumes=gov.ca.cwds.rest.core.Api.MEDIA_TYPE_JSON_V1)
