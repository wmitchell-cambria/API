 ...
 * CRUD functions to {@link CrudsResourceImpl}. It decorates the
 * {@link CrudsResourceImpl} not in functionality but with @see <a href=
...
public class AddressResource implements CrudsResource<Address> {
	...
	public gov.ca.cwds.rest.api.domain.ApiResponse<Address> create(Address domainObject, String acceptHeader,
