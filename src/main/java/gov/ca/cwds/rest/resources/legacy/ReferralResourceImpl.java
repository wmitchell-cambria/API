...
public class ReferralResourceImpl extends BaseResource<ReferralService> implements ReferralResource, CrudsResource<Referral> {
	 ...
	 */
	@Override
	@ApiOperation(value = "Create Referral", code = HttpStatus.SC_CREATED, response = Object.class, responseHeaders = @ResponseHeader(name = "Location", description = "Link to the newly created object", response = Object.class))
