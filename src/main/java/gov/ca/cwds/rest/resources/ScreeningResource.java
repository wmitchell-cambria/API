...
public class ScreeningResource implements CrudsResource<Screening> {
	...
	public Response get(String id, String acceptHeader) {
		...
		if ("1".equals(id)) {
			return Response.status(Response.Status.OK)
					.entity(new Screening((long)2,"X5HNJK", "2016-10-13T01:07", "amador", "2016-10-13", "Relative's Home", "email","first screening","immediate","accept_for_investigation","2016-10-05T01:01","first narrative", null, null)).build();
	...
	public ApiResponse<Screening> create(@Valid Screening domainObject, String acceptHeader, UriInfo uriInfo,
		...
		Screening screening = new Screening((long)2,"X5HNJK", "2016-10-13T01:07", "amador", "2016-10-13", "Relative's Home", "email","first screening","immediate","accept_for_investigation","2016-10-05T01:01","first narrative", address,involvedPersonIds);
