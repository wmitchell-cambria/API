...
/**
 * Constants defining information about our API. These resources were used in
 * the early phases of the project to utilize plumbing needed to support the
 * Digital Services team(s). They are not to be exposed in production.
 * 
...
public class ApiPoc {
	...
	/**
	 * A {@code String} constant representing {@value #RESOURCE_INTAKE_REFERRAL}
	 * api.
	 */
	...
	/**
	 * A {@code String} constant representing {@value #RESOURCE_CROSS_REPORT}
	 * api.
	 */
	 ...
	 * {@value #RESOURCE_CWS_OFFICE_ADDESS} api.
	 */
	...
	/**
	 * A {@code String} constant representing {@value #RESOURCE_REFERRAL_CLIENT}
	 * api.
	 */
	...
	/**
	 * A {@code String} constant representing {@value #RESOURCE_STAFF_PERSON}
	 * api.
	 */
	public final static String RESOURCE_STAFF_PERSON = "legacy/staffpersons";

	/**
	 * A {@code String} constant representing {@value #RESOURCE_LAW_ENFORCEMENT}
	 * api.
	 */
	public final static String RESOURCE_LAW_ENFORCEMENT = "lawEnforcements";

	/**
	 * A {@code String} constant representing {@value #MEDIA_TYPE_JSON_V1} media
	 * type.
	 */
	public final static String MEDIA_TYPE_JSON_V1 = "application/gov.ca.cwds.rest-v1+json";

	/**
	 * A {@code String} constant representing {@value #MEDIA_TYPE_NOOP} media
	 * type.
	 */
	...
	public enum Version {
		...
		/**
		 * A {@code String} constant representing {@value #VERSION_1} media
		 * type.
		 */
		 ...
		 * 
		 * @param mediaType
		 *            The media type for this version of the API
		 */
