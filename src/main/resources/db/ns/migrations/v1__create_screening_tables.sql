...
/*  Created On : 17-Oct-2016 3:43:43 PM 				*/
/*  DBMS       : PostgreSQL 						*/
/* ---------------------------------------------------- */
...
(
	...
	hotline_communication_method integer NULL,    -- Communication method that conveyed the communication (e.g., telephone, fax, etc.).
	...
	hotline_contact_county integer NULL,    -- County within which the inquiry or incident originated.
